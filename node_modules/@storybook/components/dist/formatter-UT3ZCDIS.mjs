...
`)),string+=indentedValue+strings[i+1]}),string}var formatter=memoize(2)((type,source)=>type===!1?source:type==="dedent"||type===!0?dedent(source):import_standalone.default.format(source,{parser:type,plugins:[import_parser_html.default],htmlWhitespaceSensitivity:"ignore"}).trim());export{formatter};
