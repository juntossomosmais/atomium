import { ChannelHandler, ChannelEvent, Channel } from '@storybook/channels';

interface Config {
    page: 'manager' | 'preview';
}
declare const KEY = "storybook-channel";
declare class PostmsgTransport {
...
export { KEY, PostmsgTransport, createChannel, createChannel as default };
