...
export declare function runExternalSchematic<T extends object = any>(collectionName: string, schematicName: string, options: T, tree: Tree): Promise<import("@angular-devkit/schematics/testing").UnitTestTree>;
export declare function runSchematic<T extends object = any>(schematicName: string, options: T, tree: Tree): Promise<import("@angular-devkit/schematics/testing").UnitTestTree>;
