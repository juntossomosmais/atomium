...
class FsTree {
    ...
    assertUnlocked() {
        if (this.locked) {
            ...
            if ((0, semver_1.gt)(require('../../package.json').version, '17.0.0')) {
                throw new Error('The tree has already been committed to disk. It can no longer be modified. Do not modify the tree during a GeneratorCallback and ensure that Promises have resolved before the generator returns or resolves.');
            }
            else {
