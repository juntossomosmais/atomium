...
function handleErrors(isVerbose, fn) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        try {
            ...
            err || (err = new Error('Unknown error caught'));
...
function validateObject(opts, schema, definitions) {
    ...
    ((_a = schema.required) !== null && _a !== void 0 ? _a : []).forEach((p) => {
        if (opts[p] === undefined) {
    ...
    Object.keys(opts).forEach((p) => {
        var _a;
        validateProperty(p, opts[p], ((_a = schema.properties) !== null && _a !== void 0 ? _a : {})[p], definitions);
    });
}
...
function combineOptionsForGenerator(commandLineOpts, collectionName, generatorName, projectsConfigurations, nxJsonConfiguration, schema, isInteractive, defaultProjectName, relativeCwd, isVerbose = false) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        if (isInteractive && isTTY()) {
            combined = yield promptForValues(combined, schema, projectsConfigurations);
        }
        warnDeprecations(combined, schema);
        setDefaults(combined, schema);
        validateOptsAgainstSchema(combined, schema);
...
function getGeneratorDefaults(projectName, projectsConfigurations, nxJsonConfiguration, collectionName, generatorName) {
    var _a, _b;
    let defaults = {};
    if (nxJsonConfiguration === null || nxJsonConfiguration === void 0 ? void 0 : nxJsonConfiguration.generators) {
        if ((_a = nxJsonConfiguration.generators[collectionName]) === null || _a === void 0 ? void 0 : _a[generatorName]) {
            defaults = Object.assign(Object.assign({}, defaults), nxJsonConfiguration.generators[collectionName][generatorName]);
        }
    ...
    if (projectName &&
        ((_b = projectsConfigurations === null || projectsConfigurations === void 0 ? void 0 : projectsConfigurations.projects[projectName]) === null || _b === void 0 ? void 0 : _b.generators)) {
...
function promptForValues(opts, schema, projectsConfigurations) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
