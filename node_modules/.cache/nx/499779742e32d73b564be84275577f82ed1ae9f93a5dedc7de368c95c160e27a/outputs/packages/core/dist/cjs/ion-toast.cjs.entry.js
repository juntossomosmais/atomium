...
const index$2 = require('./index-aabf0f95.js');
...
const Toast = class {
  ...
  renderToastMessage() {
    ...
    if (customHTMLEnabled) {
      return index.h("div", { class: "toast-message", part: "message", innerHTML: index$1.sanitizeDOMString(message) });
    }
...
//# sourceMappingURL=ion-toast.cjs.entry.js.map