...
const AtomSelect = class {
  ...
  render() {
    return (index.h("ion-item", null, index.h("ion-select", { name: this.name, label: this.label, "label-placement": this.labelPlacement, interface: this.interface, placeholder: this.placeholder, "cancel-text": this.cancelText, "ok-text": this.okText, disabled: this.disabled, multiple: this.multiple, color: this.color, mode: this.mode, "overlay-dismiss": this.overlayDismiss, onIonChange: this.handleChange, onIonBlur: this.handleBlur, onIonFocus: this.handleFocus }, this.options.map((option) => (index.h("ion-select-option", { value: option.value, disabled: option.disabled }, option.value))))));
  }
  get selectEl() { return index.getElement(this); }
};
AtomSelect.style = selectCss;

exports.AtomSelect = AtomSelect;

//# sourceMappingURL=select-27973e18.js.map