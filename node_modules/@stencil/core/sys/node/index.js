/*!
 Stencil Node System v3.2.0 | MIT Licensed | https://stenciljs.com
 */
...
e)), []), isString = e => "string" == typeof e, isPromise = e => !!e && ("object" == typeof e || "function" == typeof e) && "function" == typeof e.then, isGlob = e => {
 const t = {
  "{": "}",
  "(": ")",
  "[": "]"
...
lockfile = createCommonjsModule((function(e) {
 e.exports = function(e) {
  ...
  const p = /^yarn lockfile v(\d+)$/, d = "BOOLEAN", m = "STRING", g = "EOF", y = "COLON", v = "NEWLINE", E = "COMMENT", b = "INDENT", _ = "INVALID", w = "NUMBER", S = "COMMA", k = [ d, m, w ];
  class O {
   constructor(e, t = "lockfile") {
    this.comments = [], this.tokens = function* r(e) {
     ...
     for (;e.length; ) {
      let s = 0;
      if ("\n" === e[0] || "\r" === e[0]) s++, "\n" === e[1] && s++, n++, i = 0, yield t(v); else if ("#" === e[0]) {
       s++;
       let r = "";
       for (;"\n" !== e[s]; ) r += e[s], s++;
       yield t(E, r);
    ...
    for (;;) {
     ...
     if (h.type === v) {
      ...
      if (h.type === m) {
       ...
       } else if (E = a, k.indexOf(E.type) >= 0) {
