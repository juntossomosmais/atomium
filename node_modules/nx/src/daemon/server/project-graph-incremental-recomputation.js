...
function computeWorkspaceConfigHash(projectsConfigurations) {
    return new hashing_impl_1.HashingImpl().hashArray([JSON.stringify(projectsConfigurations)]);
}
function processCollectedUpdatedAndDeletedFiles() {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const projectsConfiguration = new workspaces_1.Workspaces(workspace_root_1.workspaceRoot).readProjectsConfigurations();
            const workspaceConfigHash = computeWorkspaceConfigHash(projectsConfiguration);
            ...
            if (workspaceConfigHash !== storedWorkspaceConfigHash) {
                ...
                exports.projectFileMapWithFiles = (0, file_map_utils_1.createProjectFileMap)(projectsConfiguration, file_hasher_1.defaultFileHasher.allFileData());
            }
            else {
                exports.projectFileMapWithFiles = exports.projectFileMapWithFiles
                    ? (0, file_map_utils_1.updateProjectFileMap)(projectsConfiguration, exports.projectFileMapWithFiles.projectFileMap, exports.projectFileMapWithFiles.allWorkspaceFiles, updatedFiles, deletedFiles)
                    : (0, file_map_utils_1.createProjectFileMap)(projectsConfiguration, file_hasher_1.defaultFileHasher.allFileData());
            }
