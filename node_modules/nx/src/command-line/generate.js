...
function generate(cwd, args) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        return (0, params_1.handleErrors)(verbose, () => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const { normalizedGeneratorName, schema, implementationFactory, generatorConfiguration: { aliases, hidden, ['x-deprecated']: deprecated }, } = ws.readGenerator(opts.collectionName, opts.generatorName);
            if (deprecated) {
