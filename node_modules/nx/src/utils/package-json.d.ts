...
export declare type ArrayPackageGroup = {
    package: string;
    version: string;
}[];
export declare type MixedPackageGroup = (string | {
    package: string;
    version: string;
})[] | Record<string, string>;
export declare type PackageGroup = MixedPackageGroup | ArrayPackageGroup;
export interface NxMigrationsConfiguration {
    migrations?: string;
    packageGroup?: PackageGroup;
}
declare type PackageOverride = {
