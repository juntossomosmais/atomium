...
exports.registerTsConfigPaths = exports.registerTranspiler = exports.registerTsProject = void 0;
...
function readCompilerOptionsWithTypescript(tsConfigPath) {
    const { readConfigFile, parseJsonConfigFileContent, sys } = require('typescript');
    const jsonContent = readConfigFile(tsConfigPath, sys.readFile);
    const { options } = parseJsonConfigFileContent(jsonContent, sys, (0, path_1.dirname)(tsConfigPath));
