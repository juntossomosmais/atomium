...
export declare function getExecutorNameForTask(task: Task, nxJson: NxJsonConfiguration, projectGraph: ProjectGraph): string;
...
export declare function getCustomHasher(task: Task, workspace: Workspaces, nxJson: NxJsonConfiguration, projectGraph: ProjectGraph): import("../devkit-exports").CustomHasher;
