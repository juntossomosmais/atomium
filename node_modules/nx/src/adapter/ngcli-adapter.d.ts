...
export declare class NxScopedHost extends virtualFs.ScopedHost<any> {
    ...
    mergeProjectConfiguration(existing: ProjectConfiguration, updated: ProjectConfiguration): {
        name?: string;
        targets?: {
            [targetName: string]: import("../config/workspace-json-project-json").TargetConfiguration<any>;
        };
        root: string;
        sourceRoot?: string;
        projectType?: import("../config/workspace-json-project-json").ProjectType;
        generators?: {
        ...
        namedInputs?: {
            [inputName: string]: (string | import("../config/workspace-json-project-json").InputDefinition)[];
        };
        tags?: string[];
    };
    readExistingAngularJson(): Observable<any>;
    readExistingProjectJson(path: string): Observable<any>;
}
