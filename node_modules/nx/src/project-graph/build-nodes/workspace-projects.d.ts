...
export declare function normalizeImplicitDependencies(source: string, implicitDependencies: ProjectConfiguration['implicitDependencies'], projectNames: string[], projectsSet: Set<string>): string[];
