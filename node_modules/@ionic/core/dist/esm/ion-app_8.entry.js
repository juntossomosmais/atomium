 ...
 */
import { r as registerInstance, h, H as Host, f as getElement, d as createEvent, e as readTask, i as forceUpdate, w as writeTask } from './index-be218d70.js';
import { b as getIonMode, c as config, a as isPlatform } from './ionic-global-3b28a225.js';
import { c as componentOnReady, l as clamp, i as inheritAriaAttributes, s as shallowEqualStringMap, m as hasLazyBuild } from './helpers-5eb6364d.js';
import { i as isRTL } from './dir-e8b767a8.js';
import { c as createColorClasses, h as hostContext } from './theme-7670341c.js';
import { a as findIonContent, p as printIonContentErrorMsg, g as getScrollElement } from './index-d60493fd.js';
...
import { a as attachComponent, d as detachComponent } from './framework-delegate-28f7ea29.js';
import { t as transition } from './index-93867f4c.js';
  ...
  componentDidLoad() {
    {
      rIC(async () => {
        ...
        if (!config.getBoolean('_testing')) {
          import('./index-0037f985.js').then((module) => module.startTapClick(config));
        }
        if (config.getBoolean('statusTap', isHybrid)) {
          import('./status-tap-8025f432.js').then((module) => module.startStatusTap());
        }
        if (config.getBoolean('inputShims', needInputShims())) {
          ...
          import('./input-shims-f05f58ec.js').then((module) => module.startInputShims(config, platform));
        }
...
const RouterOutlet = class {
  ...
  async connectedCallback() {
    ...
    this.gesture = (await import('./swipe-back-23e95969.js')).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => { var _a; return (_a = this.ani) === null || _a === void 0 ? void 0 : _a.progressStep(step); }, (shouldComplete, step, dur) => {
      if (this.ani) {
        this.ani.onFinish(() => {
          this.gestureOrAnimationInProgress = false;
          if (this.swipeHandler) {
