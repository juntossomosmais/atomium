...
const index$2 = require('./index-d3b5b57c.js');
  ...
  componentDidLoad() {
    {
      rIC(async () => {
        ...
        if (ionicGlobal.config.getBoolean('statusTap', isHybrid)) {
          Promise.resolve().then(function () { return require('./status-tap-2d33df8e.js'); }).then((module) => module.startStatusTap());
        }
        if (ionicGlobal.config.getBoolean('inputShims', needInputShims())) {
          ...
          Promise.resolve().then(function () { return require('./input-shims-b82cdcca.js'); }).then((module) => module.startInputShims(ionicGlobal.config, platform));
        }
