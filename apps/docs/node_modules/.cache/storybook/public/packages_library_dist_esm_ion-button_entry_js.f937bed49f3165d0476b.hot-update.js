"use strict";
globalThis["webpackHotUpdateatomium_docs"]("packages_library_dist_esm_ion-button_entry_js",{
...
const Button = class {
  constructor(hostRef) {
    ...
    this.handleClick = ev => {
      ...
      if (this.type === 'button') {
        (0,_theme_bc7eaa70_js__WEBPACK_IMPORTED_MODULE_2__.o)(this.href, ev, this.routerDirection, this.routerAnimation);
      } else if ((0,_helpers_937ea457_js__WEBPACK_IMPORTED_MODULE_3__.u)(el)) {
        ...
        if (!formEl && form !== undefined) {
          if (typeof form === 'string') {
            (0,_index_24e88bd3_js__WEBPACK_IMPORTED_MODULE_4__.p)(`Form with selector: "#${form}" could not be found. Verify that the id is correct and the form is rendered in the DOM.`, el);
          } else {
            (0,_index_24e88bd3_js__WEBPACK_IMPORTED_MODULE_4__.p)(`The provided "form" element is invalid. Verify that the form is a HTMLFormElement and rendered in the DOM.`, el);
          }
          return;
        }
        if (!formEl) {
  ...
  render() {
    ...
    return (0,_index_77c1beb5_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_77c1beb5_js__WEBPACK_IMPORTED_MODULE_0__.H, {
      ...
      class: (0,_theme_bc7eaa70_js__WEBPACK_IMPORTED_MODULE_2__.c)(color, {
        ...
        'in-buttons': (0,_theme_bc7eaa70_js__WEBPACK_IMPORTED_MODULE_2__.h)('ion-buttons', this.el),
        'button-has-icon-only': hasIconOnly,
        'button-disabled': disabled,
        'ion-activatable': true,
        'ion-focusable': true
      })
    }, (0,_index_77c1beb5_js__WEBPACK_IMPORTED_MODULE_0__.h)(TagType, Object.assign({}, attrs, {
      class: "button-native",
      part: "native",
      disabled: disabled,
      onFocus: this.onFocus,
      onBlur: this.onBlur
    }, inheritedAttributes), (0,_index_77c1beb5_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", {
      class: "button-inner"
      ...
      name: "end"
    })), mode === 'md' && (0,_index_77c1beb5_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-ripple-effect", {
...
//# sourceMappingURL=packages_library_dist_esm_ion-button_entry_js.f937bed49f3165d0476b.hot-update.js.map