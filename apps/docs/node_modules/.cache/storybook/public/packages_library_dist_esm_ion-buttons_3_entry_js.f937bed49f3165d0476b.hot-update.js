"use strict";
globalThis["webpackHotUpdateatomium_docs"]("packages_library_dist_esm_ion-buttons_3_entry_js",{
...
const PickerColumnInternal = class {
  constructor(hostRef) {
    ...
    this.initializeScrollListener = () => {
      const enableHaptics = (0,_ionic_global_98cbf2f6_js__WEBPACK_IMPORTED_MODULE_1__.a)('ios');
      const {
        el
      } = this;
      let timeout;
      ...
      const scrollCallback = () => {
        (0,_helpers_937ea457_js__WEBPACK_IMPORTED_MODULE_3__.r)(() => {
          ...
          if (activeElement !== activeEl) {
            enableHaptics && (0,_haptic_4424aedf_js__WEBPACK_IMPORTED_MODULE_2__.b)();
          ...
          timeout = setTimeout(() => {
            this.isScrolling = false;
            enableHaptics && (0,_haptic_4424aedf_js__WEBPACK_IMPORTED_MODULE_2__.c)();
            const {
              scrollEndCallback
            } = this;
  ...
  componentWillLoad() {
    const visibleCallback = entries => {
      ...
      if (ev.isIntersecting) {
        ...
        const oldActive = (0,_helpers_937ea457_js__WEBPACK_IMPORTED_MODULE_3__.g)(this.el).querySelector(`.${PICKER_COL_ACTIVE}`);
  ...
  get activeItem() {
    return (0,_helpers_937ea457_js__WEBPACK_IMPORTED_MODULE_3__.g)(this.el).querySelector(`.picker-item[data-value="${this.value}"]:not([disabled])`);
  }
  render() {
    const {
      items,
    ...
    return (0,_index_77c1beb5_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_77c1beb5_js__WEBPACK_IMPORTED_MODULE_0__.H, {
      tabindex: 0,
      class: (0,_theme_bc7eaa70_js__WEBPACK_IMPORTED_MODULE_4__.c)(color, {
        [mode]: true,
...
const PickerInternal = class {
  constructor(hostRef) {
    (0,_index_77c1beb5_js__WEBPACK_IMPORTED_MODULE_0__.r)(this, hostRef);
    this.ionInputModeChange = (0,_index_77c1beb5_js__WEBPACK_IMPORTED_MODULE_0__.d)(this, "ionInputModeChange", 7);
  ...
  componentWillLoad() {
    (0,_helpers_937ea457_js__WEBPACK_IMPORTED_MODULE_3__.g)(this.el).addEventListener('focusin', this.onFocusIn);
    (0,_helpers_937ea457_js__WEBPACK_IMPORTED_MODULE_3__.g)(this.el).addEventListener('focusout', this.onFocusOut);
  }
  async exitInputMode() {
    const {
      inputEl,
...
//# sourceMappingURL=packages_library_dist_esm_ion-buttons_3_entry_js.f937bed49f3165d0476b.hot-update.js.map