...
const Segment = class {
  constructor(hostRef) {
    ...
    this.ionSelect = (0,_index_67f415ef_js__WEBPACK_IMPORTED_MODULE_0__.e)(this, "ionSelect", 7);
  ...
  addRipple(detail) {
    const useRippleEffect = _ionic_global_2f2b712c_js__WEBPACK_IMPORTED_MODULE_1__.c.getBoolean('animated', true) && _ionic_global_2f2b712c_js__WEBPACK_IMPORTED_MODULE_1__.c.getBoolean('rippleEffect', true);
    if (!useRippleEffect) {
      return;
    }
    const buttons = this.getButtons();
...
//# sourceMappingURL=packages_library_dist_esm_ion-segment_entry_js.c47ca8902f74116b32a1.hot-update.js.map