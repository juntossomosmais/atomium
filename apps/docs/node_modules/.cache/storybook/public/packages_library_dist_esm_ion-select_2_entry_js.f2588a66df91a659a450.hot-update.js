"use strict";
globalThis["webpackHotUpdateatomium_docs"]("packages_library_dist_esm_ion-select_2_entry_js",{
...
/* harmony import */ var _index_3c3facbc_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./index-3c3facbc.js */ "../../packages/library/dist/esm/index-3c3facbc.js");
...
/* harmony import */ var _form_controller_66f6c174_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./form-controller-66f6c174.js */ "../../packages/library/dist/esm/form-controller-66f6c174.js");
...
/* harmony import */ var _dir_81e2b9f7_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./dir-81e2b9f7.js */ "../../packages/library/dist/esm/dir-81e2b9f7.js");
/* harmony import */ var _theme_bc7eaa70_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./theme-bc7eaa70.js */ "../../packages/library/dist/esm/theme-bc7eaa70.js");
...
const Select = class {
  constructor(hostRef) {
    ...
    this.ionDismiss = (0,_index_77c1beb5_js__WEBPACK_IMPORTED_MODULE_0__.d)(this, "ionDismiss", 7);
  ...
  componentWillLoad() {
    this.inheritedAttributes = (0,_helpers_937ea457_js__WEBPACK_IMPORTED_MODULE_3__.c)(this.el, ['aria-label']);
  }
  async connectedCallback() {
    const {
      el
    } = this;
    this.legacyFormController = (0,_form_controller_66f6c174_js__WEBPACK_IMPORTED_MODULE_4__.c)(el);
  ...
  async open(event) {
    ...
    if (this.interface === 'popover') {
      ...
      if (selectedItem) {
        (0,_helpers_937ea457_js__WEBPACK_IMPORTED_MODULE_3__.j)(selectedItem);
  ...
  async openPopover(ev) {
    ...
    return _overlays_10f36787_js__WEBPACK_IMPORTED_MODULE_2__.h.create(popoverOpts);
  }
  async openActionSheet() {
    ...
    return _overlays_10f36787_js__WEBPACK_IMPORTED_MODULE_2__.j.create(actionSheetOpts);
  }
  async openAlert() {
    let label;
    let labelText;
    ...
    return _overlays_10f36787_js__WEBPACK_IMPORTED_MODULE_2__.k.create(alertOpts);
  }
  close() {
    if (!this.overlay) {
  ...
  getLabel() {
    return (0,_helpers_937ea457_js__WEBPACK_IMPORTED_MODULE_3__.q)(this.el);
  }
  hasValue() {
    return this.getText() !== '';
  }
  ...
  renderSelect() {
    ...
    const rtl = (0,_dir_81e2b9f7_js__WEBPACK_IMPORTED_MODULE_5__.i)(el) ? 'rtl' : 'ltr';
    const inItem = (0,_theme_bc7eaa70_js__WEBPACK_IMPORTED_MODULE_6__.h)('ion-item', this.el);
    ...
    return (0,_index_77c1beb5_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_77c1beb5_js__WEBPACK_IMPORTED_MODULE_0__.H, {
      ...
      class: (0,_theme_bc7eaa70_js__WEBPACK_IMPORTED_MODULE_6__.c)(this.color, {
        [mode]: true,
        'in-item': inItem,
        'in-item-color': (0,_theme_bc7eaa70_js__WEBPACK_IMPORTED_MODULE_6__.h)('ion-item.ion-color', el),
    ...
    }, this.renderSelectText(), !hasFloatingOrStackedLabel && this.renderSelectIcon(), this.renderListbox()), hasFloatingOrStackedLabel && this.renderSelectIcon(), shouldRenderHighlight && (0,_index_77c1beb5_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", {
      class: "select-highlight"
    })));
  }
  renderLegacySelect() {
    if (!this.hasLoggedDeprecationWarning) {
      (0,_index_24e88bd3_js__WEBPACK_IMPORTED_MODULE_7__.p)(`ion-select now requires providing a label with either the "label" property or the "aria-label" attribute. To migrate, remove any usage of "ion-label" and pass the label text to either the "label" property or the "aria-label" attribute.
...
Developers can use the "legacy" property to continue using the legacy form markup. This property will be removed in an upcoming major release of Ionic where this form control will use the modern form markup.`, this.el);
      if (this.legacy) {
        (0,_index_24e88bd3_js__WEBPACK_IMPORTED_MODULE_7__.p)(`ion-select is being used with the "legacy" property enabled which will forcibly enable the legacy form markup. This property will be removed in an upcoming major release of Ionic where this form control will use the modern form markup.
    ...
    const {
      labelText,
      labelId
    } = (0,_helpers_937ea457_js__WEBPACK_IMPORTED_MODULE_3__.n)(el, inputId);
    (0,_helpers_937ea457_js__WEBPACK_IMPORTED_MODULE_3__.e)(true, el, name, parseValue(value), disabled);
    ...
    return (0,_index_77c1beb5_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_77c1beb5_js__WEBPACK_IMPORTED_MODULE_0__.H, {
      ...
      class: {
        [mode]: true,
        'in-item': (0,_theme_bc7eaa70_js__WEBPACK_IMPORTED_MODULE_6__.h)('ion-item', el),
        'in-item-color': (0,_theme_bc7eaa70_js__WEBPACK_IMPORTED_MODULE_6__.h)('ion-item.ion-color', el),
        'select-disabled': disabled,
        'select-expanded': isExpanded,
        'legacy-select': true
      }
    }, this.renderSelectText(), this.renderSelectIcon(), (0,_index_77c1beb5_js__WEBPACK_IMPORTED_MODULE_0__.h)("label", {
      id: labelId
  ...
  renderSelectIcon() {
    const mode = (0,_ionic_global_98cbf2f6_js__WEBPACK_IMPORTED_MODULE_1__.g)(this);
    const icon = mode === 'ios' ? _index_3c3facbc_js__WEBPACK_IMPORTED_MODULE_8__.w : _index_3c3facbc_js__WEBPACK_IMPORTED_MODULE_8__.h;
    return (0,_index_77c1beb5_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-icon", {
      class: "select-icon",
      part: "icon",
      "aria-hidden": "true",
      icon: icon
...
//# sourceMappingURL=packages_library_dist_esm_ion-select_2_entry_js.f2588a66df91a659a450.hot-update.js.map