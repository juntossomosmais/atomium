...
const Toast = class {
  constructor(hostRef) {
    ...
    this.didPresent = (0,_index_5797d131_js__WEBPACK_IMPORTED_MODULE_0__.d)(this, "ionToastDidPresent", 7);
    this.willPresent = (0,_index_5797d131_js__WEBPACK_IMPORTED_MODULE_0__.d)(this, "ionToastWillPresent", 7);
    this.willDismiss = (0,_index_5797d131_js__WEBPACK_IMPORTED_MODULE_0__.d)(this, "ionToastWillDismiss", 7);
    this.didDismiss = (0,_index_5797d131_js__WEBPACK_IMPORTED_MODULE_0__.d)(this, "ionToastDidDismiss", 7);
    ...
    this.delegateController = (0,_overlays_61f4b33d_js__WEBPACK_IMPORTED_MODULE_2__.c)(this);
    this.triggerController = (0,_overlays_61f4b33d_js__WEBPACK_IMPORTED_MODULE_2__.a)();
    this.customHTMLEnabled = _ionic_global_060edf0f_js__WEBPACK_IMPORTED_MODULE_1__.c.get('innerHTMLTemplatesEnabled', _index_9ebe46bd_js__WEBPACK_IMPORTED_MODULE_6__.E);
    this.presented = false;
    this.dispatchCancelHandler = ev => {
      const role = ev.detail.role;
      if ((0,_overlays_61f4b33d_js__WEBPACK_IMPORTED_MODULE_2__.i)(role)) {
    ...
    this.duration = _ionic_global_060edf0f_js__WEBPACK_IMPORTED_MODULE_1__.c.getNumber('toastDuration', 0);
  ...
  connectedCallback() {
    (0,_overlays_61f4b33d_js__WEBPACK_IMPORTED_MODULE_2__.p)(this.el);
    this.triggerChanged();
  }
  ...
  async present() {
    ...
    this.currentTransition = (0,_overlays_61f4b33d_js__WEBPACK_IMPORTED_MODULE_2__.b)(this, 'toastEnter', iosEnterAnimation, mdEnterAnimation, this.position);
    await this.currentTransition;
  ...
  async dismiss(data, role) {
    ...
    this.currentTransition = (0,_overlays_61f4b33d_js__WEBPACK_IMPORTED_MODULE_2__.d)(this, data, role, 'toastLeave', iosLeaveAnimation, mdLeaveAnimation, this.position);
  ...
  onDidDismiss() {
    return (0,_overlays_61f4b33d_js__WEBPACK_IMPORTED_MODULE_2__.e)(this.el, 'ionToastDidDismiss');
  }
  onWillDismiss() {
    return (0,_overlays_61f4b33d_js__WEBPACK_IMPORTED_MODULE_2__.e)(this.el, 'ionToastWillDismiss');
  }
  getButtons() {
  ...
  async callButtonHandler(button) {
    if (button === null || button === void 0 ? void 0 : button.handler) {
      try {
        const rtn = await (0,_overlays_61f4b33d_js__WEBPACK_IMPORTED_MODULE_2__.s)(button.handler);
        if (rtn === false) {
          return false;
        }
      } catch (e) {
  ...
  renderButtons(buttons, side) {
    ...
    }, buttons.map(b => (0,_index_5797d131_js__WEBPACK_IMPORTED_MODULE_0__.h)("button", {
      type: "button",
      class: buttonClass(b),
      tabIndex: 0,
    ...
    }), b.text), mode === 'md' && (0,_index_5797d131_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-ripple-effect", {
  ...
  render() {
    ...
    return (0,_index_5797d131_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_5797d131_js__WEBPACK_IMPORTED_MODULE_0__.H, Object.assign({
      ...
      part: "container"
    }, this.renderButtons(startButtons, 'start'), this.icon !== undefined && (0,_index_5797d131_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-icon", {
      class: "toast-icon",
      part: "icon",
      icon: this.icon,
      lazy: false,
      ...
      class: "toast-content"
    }, this.header !== undefined && (0,_index_5797d131_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", {
      class: "toast-header",
      part: "header"
...
//# sourceMappingURL=packages_library_dist_esm_ion-toast_entry_js.78ed4743f696cb0dc047.hot-update.js.map