"use strict";
(globalThis["webpackChunkatomium_docs"] = globalThis["webpackChunkatomium_docs"] || []).push([["packages_library_dist_esm_ion-nav_entry_js"],{
...
const Nav = class {
  ...
  componentWillLoad() {
    ...
    if (this.swipeGesture === undefined) {
      ...
      this.swipeGesture = _ionic_global_98cbf2f6_js__WEBPACK_IMPORTED_MODULE_1__.c.getBoolean('swipeBackEnabled', mode === 'ios');
    }
  ...
  disconnectedCallback() {
    for (const view of this.views) {
      (0,_index_29effbee_js__WEBPACK_IMPORTED_MODULE_2__.l)(view.element, _index_29effbee_js__WEBPACK_IMPORTED_MODULE_2__.L);
      view._destroy();
    }
    if (this.gesture) {
  ...
  postViewInit(enteringView, leavingView, ti) {
    ...
    if (destroyQueue && destroyQueue.length > 0) {
      for (const view of destroyQueue) {
        (0,_index_29effbee_js__WEBPACK_IMPORTED_MODULE_2__.l)(view.element, _index_29effbee_js__WEBPACK_IMPORTED_MODULE_2__.a);
        (0,_index_29effbee_js__WEBPACK_IMPORTED_MODULE_2__.l)(view.element, _index_29effbee_js__WEBPACK_IMPORTED_MODULE_2__.b);
        (0,_index_29effbee_js__WEBPACK_IMPORTED_MODULE_2__.l)(view.element, _index_29effbee_js__WEBPACK_IMPORTED_MODULE_2__.L);
      }
      for (const view of destroyQueue) {
  ...
  async transition(enteringView, leavingView, ti) {
    ...
    const animationOpts = Object.assign(Object.assign({
      ...
      baseEl: this.el,
      progressCallback,
      animated: this.animated && _ionic_global_98cbf2f6_js__WEBPACK_IMPORTED_MODULE_1__.c.getBoolean('animated', true),
      enteringEl,
      leavingEl
    }, opts), {
      animationBuilder: opts.animationBuilder || this.animation || _ionic_global_98cbf2f6_js__WEBPACK_IMPORTED_MODULE_1__.c.get('navAnimation')
    });
    const {
      hasCompleted
    } = await (0,_index_29effbee_js__WEBPACK_IMPORTED_MODULE_2__.t)(animationOpts);
    ...
    for (let i = views.length - 1; i >= 0; i--) {
      ...
      if (element) {
        if (i > activeViewIndex) {
          (0,_index_29effbee_js__WEBPACK_IMPORTED_MODULE_2__.l)(element, _index_29effbee_js__WEBPACK_IMPORTED_MODULE_2__.L);
          this.destroyView(view);
        } else if (i < activeViewIndex) {
          (0,_index_29effbee_js__WEBPACK_IMPORTED_MODULE_2__.s)(element, true);
        }
      }
    }
  }
...
//# sourceMappingURL=packages_library_dist_esm_ion-nav_entry_js.iframe.bundle.js.map