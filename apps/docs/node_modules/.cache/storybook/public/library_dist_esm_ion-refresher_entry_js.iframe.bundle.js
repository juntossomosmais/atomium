"use strict";
(self["webpackChunkatomium_storybook"] = self["webpackChunkatomium_storybook"] || []).push([["library_dist_esm_ion-refresher_entry_js"],{
...
/***/ "../library/dist/esm/ion-refresher.entry.js":
/*!**************************************************!*\
  !*** ../library/dist/esm/ion-refresher.entry.js ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _cubic_bezier_1aed87b5_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./cubic-bezier-1aed87b5.js */ "../library/dist/esm/cubic-bezier-1aed87b5.js");
...
/* harmony import */ var _haptic_4424aedf_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./haptic-4424aedf.js */ "../library/dist/esm/haptic-4424aedf.js");
/* harmony import */ var _animation_052dd1a1_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./animation-052dd1a1.js */ "../library/dist/esm/animation-052dd1a1.js");
/* harmony import */ var _index_37371a87_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./index-37371a87.js */ "../library/dist/esm/index-37371a87.js");
...
const createBaseAnimation = pullingRefresherIcon => {
  ...
  const baseAnimation = (0,_animation_052dd1a1_js__WEBPACK_IMPORTED_MODULE_4__.c)().duration(1000).easing('ease-out');
  const spinnerArrowContainerAnimation = (0,_animation_052dd1a1_js__WEBPACK_IMPORTED_MODULE_4__.c)().addElement(spinnerArrowContainer).keyframes([{
    offset: 0,
    opacity: '0.3'
  }, {
    offset: 0.45,
  ...
  const circleInnerAnimation = (0,_animation_052dd1a1_js__WEBPACK_IMPORTED_MODULE_4__.c)().addElement(circle).keyframes([{
    offset: 0,
  ...
  const circleOuterAnimation = (0,_animation_052dd1a1_js__WEBPACK_IMPORTED_MODULE_4__.c)().addElement(spinner).keyframes([{
    offset: 0,
  ...
  if (arrowContainer && arrow) {
    const arrowContainerAnimation = (0,_animation_052dd1a1_js__WEBPACK_IMPORTED_MODULE_4__.c)().addElement(arrowContainer).keyframes([{
      offset: 0,
    ...
    const arrowAnimation = (0,_animation_052dd1a1_js__WEBPACK_IMPORTED_MODULE_4__.c)().addElement(arrow).keyframes([{
      offset: 0,
...
const createScaleAnimation = (pullingRefresherIcon, refresherEl) => {
  ...
  const spinnerAnimation = (0,_animation_052dd1a1_js__WEBPACK_IMPORTED_MODULE_4__.c)().addElement(pullingRefresherIcon).keyframes([{
    offset: 0,
...
const createSnapBackAnimation = pullingRefresherIcon => {
  return (0,_animation_052dd1a1_js__WEBPACK_IMPORTED_MODULE_4__.c)().duration(125).addElement(pullingRefresherIcon).fromTo('transform', 'translateY(var(--ion-pulling-refresher-translate, 100px))', 'translateY(0px)');
};
...
const handleScrollWhilePulling = (ticks, numTicks, pullAmount) => {
  ...
  (0,_index_5797d131_js__WEBPACK_IMPORTED_MODULE_0__.w)(() => {
    ticks.forEach((el, i) => {
      ...
      const progression = (0,_helpers_50710f77_js__WEBPACK_IMPORTED_MODULE_6__.f)(0, start / range, 1);
...
const translateElement = (el, value, duration = 200) => {
  ...
  const trans = (0,_helpers_50710f77_js__WEBPACK_IMPORTED_MODULE_6__.t)(el, duration);
  (0,_index_5797d131_js__WEBPACK_IMPORTED_MODULE_0__.w)(() => {
...
const shouldUseNativeRefresher = async (referenceEl, mode) => {
  ...
  await new Promise(resolve => (0,_helpers_50710f77_js__WEBPACK_IMPORTED_MODULE_6__.d)(refresherContent, resolve));
  const pullingSpinner = referenceEl.querySelector('ion-refresher-content .refresher-pulling ion-spinner');
  const refreshingSpinner = referenceEl.querySelector('ion-refresher-content .refresher-refreshing ion-spinner');
  return pullingSpinner !== null && refreshingSpinner !== null && (mode === 'ios' && (0,_ionic_global_060edf0f_js__WEBPACK_IMPORTED_MODULE_1__.a)('mobile') && referenceEl.style.webkitOverflowScrolling !== undefined || mode === 'md');
};
...
const Refresher = class {
  constructor(hostRef) {
    ...
    this.ionRefresh = (0,_index_5797d131_js__WEBPACK_IMPORTED_MODULE_0__.d)(this, "ionRefresh", 7);
    this.ionPull = (0,_index_5797d131_js__WEBPACK_IMPORTED_MODULE_0__.d)(this, "ionPull", 7);
    this.ionStart = (0,_index_5797d131_js__WEBPACK_IMPORTED_MODULE_0__.d)(this, "ionStart", 7);
  ...
  async checkNativeRefresher() {
    const useNativeRefresher = await shouldUseNativeRefresher(this.el, (0,_ionic_global_060edf0f_js__WEBPACK_IMPORTED_MODULE_1__.g)(this));
  ...
  async resetNativeRefresher(el, state) {
    ...
    if ((0,_ionic_global_060edf0f_js__WEBPACK_IMPORTED_MODULE_1__.g)(this) === 'ios') {
      ...
      await (0,_helpers_50710f77_js__WEBPACK_IMPORTED_MODULE_6__.t)(this.el.querySelector('.refresher-refreshing-icon'), 200);
    }
    this.didRefresh = false;
    this.needsCompletion = false;
    this.pointerDown = false;
  ...
  async setupiOSNativeRefresher(pullingSpinner, refreshingSpinner) {
    ...
    (0,_index_5797d131_js__WEBPACK_IMPORTED_MODULE_0__.w)(() => ticks.forEach(el => el.style.setProperty('animation', 'none')));
    this.scrollListenerCallback = () => {
      ...
      (0,_index_5797d131_js__WEBPACK_IMPORTED_MODULE_0__.i)(() => {
        ...
        if (scrollTop > 0) {
          if (this.state === 8) {
            const ratio = (0,_helpers_50710f77_js__WEBPACK_IMPORTED_MODULE_6__.f)(0, scrollTop / (refresherHeight * 0.5), 1);
            (0,_index_5797d131_js__WEBPACK_IMPORTED_MODULE_0__.w)(() => setSpinnerOpacity(refreshingSpinner, 1 - ratio));
            return;
          }
          return;
        }
        ...
        const pullAmount = this.progress = (0,_helpers_50710f77_js__WEBPACK_IMPORTED_MODULE_6__.f)(0, (Math.abs(scrollTop) - offset) / MAX_PULL, 1);
    ...
    this.gesture = (await Promise.all(/*! import() */[__webpack_require__.e("library_dist_esm_index-e65e72c8_js"), __webpack_require__.e("library_dist_esm_gesture-controller-c7c60b38_js")]).then(__webpack_require__.bind(__webpack_require__, /*! ./index-e65e72c8.js */ "../library/dist/esm/index-e65e72c8.js"))).createGesture({
      el: this.scrollEl,
      ...
      onEnd: () => {
        ...
        if (this.needsCompletion) {
          ...
          (0,_index_5797d131_js__WEBPACK_IMPORTED_MODULE_0__.i)(() => translateElement(this.elementToTransform, `${this.el.clientHeight}px`));
        }
      }
    });
  ...
  async setupMDNativeRefresher(contentEl, pullingSpinner, refreshingSpinner) {
    const circle = (0,_helpers_50710f77_js__WEBPACK_IMPORTED_MODULE_6__.g)(pullingSpinner).querySelector('circle');
    const pullingRefresherIcon = this.el.querySelector('ion-refresher-content .refresher-pulling-icon');
    const refreshingCircle = (0,_helpers_50710f77_js__WEBPACK_IMPORTED_MODULE_6__.g)(refreshingSpinner).querySelector('circle');
    ...
    this.gesture = (await Promise.all(/*! import() */[__webpack_require__.e("library_dist_esm_index-e65e72c8_js"), __webpack_require__.e("library_dist_esm_gesture-controller-c7c60b38_js")]).then(__webpack_require__.bind(__webpack_require__, /*! ./index-e65e72c8.js */ "../library/dist/esm/index-e65e72c8.js"))).createGesture({
      ...
      onMove: ev => {
        ...
        if (!ev.data.didStart) {
          ...
          this.state = 2;
          (0,_index_5797d131_js__WEBPACK_IMPORTED_MODULE_0__.w)(() => this.scrollEl.style.setProperty('--overflow', 'hidden'));
        ...
        this.progress = (0,_helpers_50710f77_js__WEBPACK_IMPORTED_MODULE_6__.f)(0, ev.deltaY / 180 * 0.5, 1);
      ...
      onEnd: ev => {
        ...
        (0,_index_5797d131_js__WEBPACK_IMPORTED_MODULE_0__.w)(() => this.scrollEl.style.removeProperty('--overflow'));
        ...
        (0,_index_5797d131_js__WEBPACK_IMPORTED_MODULE_0__.w)(async () => {
  ...
  async connectedCallback() {
    ...
    const contentEl = this.el.closest(_index_07667280_js__WEBPACK_IMPORTED_MODULE_2__.I);
    if (!contentEl) {
      (0,_index_07667280_js__WEBPACK_IMPORTED_MODULE_2__.p)(this.el);
      return;
    }
    (0,_helpers_50710f77_js__WEBPACK_IMPORTED_MODULE_6__.d)(contentEl, async () => {
      const customScrollTarget = contentEl.querySelector(_index_07667280_js__WEBPACK_IMPORTED_MODULE_2__.b);
      this.scrollEl = await (0,_index_07667280_js__WEBPACK_IMPORTED_MODULE_2__.g)(customScrollTarget !== null && customScrollTarget !== void 0 ? customScrollTarget : contentEl);
      this.backgroundContentEl = await contentEl.getBackgroundElement();
      if (await shouldUseNativeRefresher(this.el, (0,_ionic_global_060edf0f_js__WEBPACK_IMPORTED_MODULE_1__.g)(this))) {
        this.setupNativeRefresher(contentEl);
      } else {
        this.gesture = (await Promise.all(/*! import() */[__webpack_require__.e("library_dist_esm_index-e65e72c8_js"), __webpack_require__.e("library_dist_esm_gesture-controller-c7c60b38_js")]).then(__webpack_require__.bind(__webpack_require__, /*! ./index-e65e72c8.js */ "../library/dist/esm/index-e65e72c8.js"))).createGesture({
          el: contentEl,
  ...
  async complete() {
    if (this.nativeRefresher) {
      ...
      if (!this.pointerDown) {
        (0,_helpers_50710f77_js__WEBPACK_IMPORTED_MODULE_6__.r)(() => (0,_helpers_50710f77_js__WEBPACK_IMPORTED_MODULE_6__.r)(() => this.resetNativeRefresher(this.elementToTransform, 32)));
      }
    } else {
      this.close(32, '120ms');
    }
  ...
  async cancel() {
    if (this.nativeRefresher) {
      if (!this.pointerDown) {
        (0,_helpers_50710f77_js__WEBPACK_IMPORTED_MODULE_6__.r)(() => (0,_helpers_50710f77_js__WEBPACK_IMPORTED_MODULE_6__.r)(() => this.resetNativeRefresher(this.elementToTransform, 16)));
      }
    } else {
      this.close(16, '');
    }
...
//# sourceMappingURL=library_dist_esm_ion-refresher_entry_js.iframe.bundle.js.map