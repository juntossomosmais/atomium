"use strict";
(self["webpackChunkatomium_storybook"] = self["webpackChunkatomium_storybook"] || []).push([["library_dist_esm_ion-button_entry_js"],{
...
/***/ "../library/dist/esm/ion-button.entry.js":
/*!***********************************************!*\
  !*** ../library/dist/esm/ion-button.entry.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const Button = class {
  constructor(hostRef) {
    ...
    this.handleClick = ev => {
      ...
      if (this.type === 'button') {
      ...
      } else if ((0,_helpers_50710f77_js__WEBPACK_IMPORTED_MODULE_3__.q)(el)) {
        ...
        if (!formEl && form !== undefined) {
          if (typeof form === 'string') {
            (0,_index_e272395f_js__WEBPACK_IMPORTED_MODULE_4__.a)(`Form with selector: "#${form}" could not be found. Verify that the id is correct and the form is rendered in the DOM.`, el);
          } else {
            (0,_index_e272395f_js__WEBPACK_IMPORTED_MODULE_4__.a)(`The provided "form" element is invalid. Verify that the form is a HTMLFormElement and rendered in the DOM.`, el);
          }
          return;
        }
        if (!formEl) {
  ...
  render() {
    ...
    return (0,_index_5797d131_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_5797d131_js__WEBPACK_IMPORTED_MODULE_0__.H, {
      ...
      onBlur: this.onBlur
    }, inheritedAttributes), (0,_index_5797d131_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", {
      class: "button-inner"
...
//# sourceMappingURL=library_dist_esm_ion-button_entry_js.iframe.bundle.js.map