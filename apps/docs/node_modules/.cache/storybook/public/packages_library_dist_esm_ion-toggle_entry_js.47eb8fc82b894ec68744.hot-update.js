...
const Toggle = class {
  constructor(hostRef) {
    ...
    this.disabled = false;
    this.value = 'on';
    this.enableOnOffLabels = _ionic_global_060edf0f_js__WEBPACK_IMPORTED_MODULE_1__.c.get('toggleOnOffLabels');
  ...
  renderToggleControl() {
    ...
    return (0,_index_5797d131_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", {
      class: "toggle-icon",
      part: "track"
    }, enableOnOffLabels && mode === 'ios' && [this.renderOnOffSwitchLabels(mode, true), this.renderOnOffSwitchLabels(mode, false)], (0,_index_5797d131_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", {
  ...
  renderToggle() {
    ...
    }, this.inheritedAttributes)), (0,_index_5797d131_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", {
      class: {
...
Developers can dismiss this warning by removing their usage of the "legacy" property and using the new toggle syntax.`, this.el);
    ...
    }, this.renderToggleControl(), (0,_index_5797d131_js__WEBPACK_IMPORTED_MODULE_0__.h)("label", {
      htmlFor: inputId
...
//# sourceMappingURL=packages_library_dist_esm_ion-toggle_entry_js.47eb8fc82b894ec68744.hot-update.js.map