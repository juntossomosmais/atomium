    ...
    console.warn('unable to connect to top frame for connecting dev tools');
      ...
      #storybook-docs[hidden] {
        display: none !important;
            ...
            window['STORIES'] = [{"titlePrefix":"","directory":"./stories","files":"*.stories.@(js|jsx|ts|tsx|mdx)","importPathMatcher":"^\\.[\\\\/](?:stories\\/(?!\\.)(?=.)[^/]*?\\.stories\\.(js|jsx|ts|tsx|mdx))$"},{"titlePrefix":"","directory":"../../packages/core/src","files":"**/*.core.stories.@(js|jsx|ts|tsx|mdx)","importPathMatcher":"^(?:\\.\\.\\/\\.\\.\\/packages\\/core\\/src(?:\\/(?!\\.)(?:(?:(?!(?:^|\\/)\\.).)*?)\\/|\\/|$)(?!\\.)(?=.)[^/]*?\\.core\\.stories\\.(js|jsx|ts|tsx|mdx))$"},{"titlePrefix":"","directory":"../../packages/tokens/stories","files":"**/*.stories.@(js|jsx|ts|tsx|mdx)","importPathMatcher":"^(?:\\.\\.\\/\\.\\.\\/packages\\/tokens\\/stories(?:\\/(?!\\.)(?:(?:(?!(?:^|\\/)\\.).)*?)\\/|\\/|$)(?!\\.)(?=.)[^/]*?\\.stories\\.(js|jsx|ts|tsx|mdx))$"}];
      ...
      import './vendors-node_modules_storybook_addon-a11y_dist_preview_mjs-node_modules_storybook_addon-actio-902a94.iframe.bundle.js';
