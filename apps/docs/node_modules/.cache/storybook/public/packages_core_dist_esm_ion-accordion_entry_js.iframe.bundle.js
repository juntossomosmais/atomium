"use strict";
(globalThis["webpackChunk_atomium_docs"] = globalThis["webpackChunk_atomium_docs"] || []).push([["packages_core_dist_esm_ion-accordion_entry_js"],{
...
/***/ "../../packages/core/dist/esm/ion-accordion.entry.js":
/*!***********************************************************!*\
  !*** ../../packages/core/dist/esm/ion-accordion.entry.js ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const Accordion = class {
  constructor(hostRef) {
    ...
    this.setAria = (expanded = false) => {
      ...
      const root = (0,_helpers_937ea457_js__WEBPACK_IMPORTED_MODULE_2__.g)(ionItem);
    ...
    this.expandAccordion = (initialUpdate = false) => {
      ...
      if (this.shouldAnimate()) {
        (0,_helpers_937ea457_js__WEBPACK_IMPORTED_MODULE_2__.r)(() => {
          this.state = 8;
          this.currentRaf = (0,_helpers_937ea457_js__WEBPACK_IMPORTED_MODULE_2__.r)(async () => {
            const contentHeight = contentElWrapper.offsetHeight;
            const waitForTransition = (0,_helpers_937ea457_js__WEBPACK_IMPORTED_MODULE_2__.t)(contentEl, 2000);
    ...
    this.collapseAccordion = (initialUpdate = false) => {
      ...
      if (this.shouldAnimate()) {
        this.currentRaf = (0,_helpers_937ea457_js__WEBPACK_IMPORTED_MODULE_2__.r)(async () => {
          ...
          contentEl.style.setProperty('max-height', `${contentHeight}px`);
          (0,_helpers_937ea457_js__WEBPACK_IMPORTED_MODULE_2__.r)(async () => {
            const waitForTransition = (0,_helpers_937ea457_js__WEBPACK_IMPORTED_MODULE_2__.t)(contentEl, 2000);
            this.state = 2;
            await waitForTransition;
            this.state = 1;
    ...
    this.shouldAnimate = () => {
      ...
      const animated = _ionic_global_4a637317_js__WEBPACK_IMPORTED_MODULE_1__.c.get('animated', true);
      if (!animated) {
        return false;
      }
    ...
    this.disabled = false;
    this.readonly = false;
    this.toggleIcon = _index_3c3facbc_js__WEBPACK_IMPORTED_MODULE_3__.c;
  ...
  connectedCallback() {
    ...
    if (accordionGroupEl) {
      ...
      (0,_helpers_937ea457_js__WEBPACK_IMPORTED_MODULE_2__.a)(accordionGroupEl, 'ionValueChange', this.updateListener);
    }
  }
  disconnectedCallback() {
    const accordionGroupEl = this.accordionGroupEl;
    if (accordionGroupEl) {
      (0,_helpers_937ea457_js__WEBPACK_IMPORTED_MODULE_2__.b)(accordionGroupEl, 'ionValueChange', this.updateListener);
    }
  }
  componentDidLoad() {
    this.setItemDefaults();
  ...
  render() {
    ...
    return (0,_index_a869d52d_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_a869d52d_js__WEBPACK_IMPORTED_MODULE_0__.H, {
      class: {
        ...
        'accordion-animated': _ionic_global_4a637317_js__WEBPACK_IMPORTED_MODULE_1__.c.getBoolean('animated', true)
      }
...
//# sourceMappingURL=packages_core_dist_esm_ion-accordion_entry_js.iframe.bundle.js.map