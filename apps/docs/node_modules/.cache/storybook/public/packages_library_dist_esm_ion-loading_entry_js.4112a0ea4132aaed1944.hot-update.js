...
const Loading = class {
  constructor(hostRef) {
    ...
    this.customHTMLEnabled = _ionic_global_060edf0f_js__WEBPACK_IMPORTED_MODULE_1__.c.get('innerHTMLTemplatesEnabled', _index_9ebe46bd_js__WEBPACK_IMPORTED_MODULE_5__.E);
  ...
  async present() {
    ...
    this.currentTransition = (0,_overlays_61f4b33d_js__WEBPACK_IMPORTED_MODULE_2__.b)(this, 'loadingEnter', iosEnterAnimation, mdEnterAnimation);
    await this.currentTransition;
    if (this.duration > 0) {
  ...
  async dismiss(data, role) {
    ...
    this.currentTransition = (0,_overlays_61f4b33d_js__WEBPACK_IMPORTED_MODULE_2__.d)(this, data, role, 'loadingLeave', iosLeaveAnimation, mdLeaveAnimation);
  ...
  onDidDismiss() {
    return (0,_overlays_61f4b33d_js__WEBPACK_IMPORTED_MODULE_2__.e)(this.el, 'ionLoadingDidDismiss');
  }
  onWillDismiss() {
    return (0,_overlays_61f4b33d_js__WEBPACK_IMPORTED_MODULE_2__.e)(this.el, 'ionLoadingWillDismiss');
  }
...
//# sourceMappingURL=packages_library_dist_esm_ion-loading_entry_js.4112a0ea4132aaed1944.hot-update.js.map