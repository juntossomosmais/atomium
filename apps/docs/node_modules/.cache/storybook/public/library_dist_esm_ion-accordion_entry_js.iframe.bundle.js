"use strict";
(self["webpackChunkatomium_storybook"] = self["webpackChunkatomium_storybook"] || []).push([["library_dist_esm_ion-accordion_entry_js"],{
...
/***/ "../library/dist/esm/ion-accordion.entry.js":
/*!**************************************************!*\
  !*** ../library/dist/esm/ion-accordion.entry.js ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const Accordion = class {
  constructor(hostRef) {
    ...
    this.disabled = false;
    this.readonly = false;
    this.toggleIcon = _index_92f00180_js__WEBPACK_IMPORTED_MODULE_2__.c;
    ...
    this.setAria = (expanded = false) => {
      ...
      const root = (0,_helpers_50710f77_js__WEBPACK_IMPORTED_MODULE_3__.g)(ionItem);
    ...
    this.expandAccordion = (initialUpdate = false) => {
      ...
      if (this.shouldAnimate()) {
        (0,_helpers_50710f77_js__WEBPACK_IMPORTED_MODULE_3__.r)(() => {
          this.state = 8;
          this.currentRaf = (0,_helpers_50710f77_js__WEBPACK_IMPORTED_MODULE_3__.r)(async () => {
            const contentHeight = contentElWrapper.offsetHeight;
            const waitForTransition = (0,_helpers_50710f77_js__WEBPACK_IMPORTED_MODULE_3__.t)(contentEl, 2000);
    ...
    this.collapseAccordion = (initialUpdate = false) => {
      ...
      if (this.shouldAnimate()) {
        this.currentRaf = (0,_helpers_50710f77_js__WEBPACK_IMPORTED_MODULE_3__.r)(async () => {
          ...
          contentEl.style.setProperty('max-height', `${contentHeight}px`);
          (0,_helpers_50710f77_js__WEBPACK_IMPORTED_MODULE_3__.r)(async () => {
            const waitForTransition = (0,_helpers_50710f77_js__WEBPACK_IMPORTED_MODULE_3__.t)(contentEl, 2000);
            this.state = 2;
            await waitForTransition;
            this.state = 1;
    ...
    this.shouldAnimate = () => {
      ...
      const animated = _ionic_global_060edf0f_js__WEBPACK_IMPORTED_MODULE_1__.c.get('animated', true);
      if (!animated) {
        return false;
      }
  ...
  connectedCallback() {
    ...
    if (accordionGroupEl) {
      ...
      (0,_helpers_50710f77_js__WEBPACK_IMPORTED_MODULE_3__.a)(accordionGroupEl, 'ionChange', this.updateListener);
    }
  }
  disconnectedCallback() {
    const accordionGroupEl = this.accordionGroupEl;
    if (accordionGroupEl) {
      (0,_helpers_50710f77_js__WEBPACK_IMPORTED_MODULE_3__.b)(accordionGroupEl, 'ionChange', this.updateListener);
    }
  }
  componentDidLoad() {
    this.setItemDefaults();
  ...
  render() {
    ...
    return (0,_index_5797d131_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_5797d131_js__WEBPACK_IMPORTED_MODULE_0__.H, {
      class: {
        ...
        'accordion-animated': _ionic_global_060edf0f_js__WEBPACK_IMPORTED_MODULE_1__.c.getBoolean('animated', true)
      }
...
//# sourceMappingURL=library_dist_esm_ion-accordion_entry_js.iframe.bundle.js.map