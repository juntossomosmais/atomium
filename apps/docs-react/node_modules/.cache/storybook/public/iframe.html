    ...
    console.warn('unable to connect to top frame for connecting dev tools');
      ...
      #storybook-docs[hidden] {
        display: none !important;
            ...
            window['STORIES'] = [{"titlePrefix":"","directory":"./stories","files":"*.stories.@(js|jsx|ts|tsx|mdx)","importPathMatcher":"^\\.[\\\\/](?:stories\\/(?!\\.)(?=.)[^/]*?\\.stories\\.(js|jsx|ts|tsx|mdx))$"},{"titlePrefix":"","directory":"../../packages/core/src","files":"**/*.react.stories.@(js|jsx|ts|tsx|mdx)","importPathMatcher":"^(?:\\.\\.\\/\\.\\.\\/packages\\/core\\/src(?:\\/(?!\\.)(?:(?:(?!(?:^|\\/)\\.).)*?)\\/|\\/|$)(?!\\.)(?=.)[^/]*?\\.react\\.stories\\.(js|jsx|ts|tsx|mdx))$"}];
            ...
            window['SERVER_CHANNEL_URL'] = "ws://localhost:7006/storybook-server-channel";</script><script type="module">import './sb-preview/runtime.mjs';

      
      import './runtime~main.iframe.bundle.js';
      
      import './vendors-node_modules_storybook_addon-a11y_dist_preview_mjs-node_modules_storybook_addon-actio-7b52f8.iframe.bundle.js';
