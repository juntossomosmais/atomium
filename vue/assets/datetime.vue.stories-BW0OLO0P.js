...
return undefined;\``},me={title:"Components/Datetime",...te},r={render:e=>({components:{AtomDatetime:t},setup(){return{args:e}},template:`
      <AtomDatetime
    ...
    `}),args:{...ae}},i={render:()=>({components:{AtomDatetime:t},setup(){return{isDateEnabled:a=>{const o=new Date(a).getUTCDay();return o!==0&&o!==6}}},template:`
    ...
    `})},b=()=>{const e=new Date,a=new Date;a.setDate(e.getDate()-30);const n=o=>o.toISOString().slice(0,10);return[n(a),n(e)]},oe=new Date().toISOString().slice(0,10),u={render:()=>({components:{AtomDatetime:t},data(){return{defaultDates:b()}},template:`
    ...
    `}),parameters:{docs:{description:{story:"This example shows the Datetime component in range mode with button interface, default dates (last 30 days), and custom Portuguese text in the button."}}}},h={render:()=>({components:{AtomDatetime:t},data(){return{summerDates:b()}},template:`
      ...
      />
    `}),parameters:{docs:{description:{story:"This example demonstrates range mode with min/max constraints and default last 30 days selection (max is today)."}}}},g={render:e=>({components:{AtomDatetime:t,AtomCol:Z,AtomGrid:Y},setup(){return{args:e}},template:`
      <AtomGrid>
        <AtomCol size="8">
          <AtomDatetime
            useButton="true"
    ...
    `}),parameters:{docs:{description:{story:'This example shows how to customize the button text to display "7 dias selecionados" instead of the default "7 days" text.'}}}};var y,x,w;r.parameters={...r.parameters,docs:{...(y=r.parameters)==null?void 0:y.docs,source:{originalSource:`{
  render: args => ({
    components: {
      AtomDatetime
    },
...
}`,...(w=(x=r.parameters)==null?void 0:x.docs)==null?void 0:w.source}}};var T,C,A;i.parameters={...i.parameters,docs:{...(T=i.parameters)==null?void 0:T.docs,source:{originalSource:`{
  render: () => ({
    components: {
      AtomDatetime
    },
...
}`,...(A=(C=i.parameters)==null?void 0:C.docs)==null?void 0:A.source}}};var S,B,$;l.parameters={...l.parameters,docs:{...(S=l.parameters)==null?void 0:S.docs,source:{originalSource:`{
  render: args => ({
    components: {
      AtomDatetime
    },
...
}`,...($=(B=l.parameters)==null?void 0:B.docs)==null?void 0:$.source}}};var v,I,M;d.parameters={...d.parameters,docs:{...(v=d.parameters)==null?void 0:v.docs,source:{originalSource:`{
  render: () => ({
    components: {
      AtomDatetime
    },
...
}`,...(M=(I=d.parameters)==null?void 0:I.docs)==null?void 0:M.source}}};var k,L,V;m.parameters={...m.parameters,docs:{...(k=m.parameters)==null?void 0:k.docs,source:{originalSource:`{
  render: () => ({
    components: {
      AtomDatetime
    },
...
}`,...(V=(L=m.parameters)==null?void 0:L.docs)==null?void 0:V.source}}};var R,z,E;c.parameters={...c.parameters,docs:{...(R=c.parameters)==null?void 0:R.docs,source:{originalSource:`{
  render: () => ({
    components: {
      AtomDatetime
    },
...
}`,...(E=(z=c.parameters)==null?void 0:z.docs)==null?void 0:E.source}}};var O,U,W;u.parameters={...u.parameters,docs:{...(O=u.parameters)==null?void 0:O.docs,source:{originalSource:`{
  render: () => ({
    components: {
      AtomDatetime
    },
...
}`,...(W=(U=u.parameters)==null?void 0:U.docs)==null?void 0:W.source}}};var G,H,P;p.parameters={...p.parameters,docs:{...(G=p.parameters)==null?void 0:G.docs,source:{originalSource:`{
  render: () => ({
    components: {
      AtomDatetime
    },
...
}`,...(P=(H=p.parameters)==null?void 0:H.docs)==null?void 0:P.source}}};var _,F,j;h.parameters={...h.parameters,docs:{...(_=h.parameters)==null?void 0:_.docs,source:{originalSource:`{
  render: () => ({
    components: {
      AtomDatetime
    },
...
}`,...(j=(F=h.parameters)==null?void 0:F.docs)==null?void 0:j.source}}};var q,J,K;g.parameters={...g.parameters,docs:{...(q=g.parameters)==null?void 0:q.docs,source:{originalSource:`{
  render: args => ({
    components: {
      AtomDatetime,
      AtomCol,
...
}`,...(K=(J=g.parameters)==null?void 0:J.docs)==null?void 0:K.source}}};var N,Q,X;D.parameters={...D.parameters,docs:{...(N=D.parameters)==null?void 0:N.docs,source:{originalSource:`{
  render: () => ({
    components: {
      AtomDatetime
    },
...
}`,...(X=(Q=D.parameters)==null?void 0:Q.docs)==null?void 0:X.source}}};const ce=["Default","AdvancedDateConstraints","HighlightingSpecificDatesArray","HighlightingSpecificDatesCallback","WithMultipleDates","UsingRangeMode","RangeModeWithDefaultDates","RangeModeWithDefaultDatesAndButton","RangeModeWithMinMax","UsingWithButton","RangeModeCustomButtonText"];export{i as AdvancedDateConstraints,r as Default,l as HighlightingSpecificDatesArray,d as HighlightingSpecificDatesCallback,D as RangeModeCustomButtonText,u as RangeModeWithDefaultDates,p as RangeModeWithDefaultDatesAndButton,h as RangeModeWithMinMax,c as UsingRangeMode,g as UsingWithButton,m as WithMultipleDates,ce as __namedExportsOrder,me as default};
