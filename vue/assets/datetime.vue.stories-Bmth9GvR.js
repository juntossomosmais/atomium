...
return undefined;\``},I={title:"Components/Datetime",...T},r={render:e=>({components:{AtomDatetime:t},setup(){return{args:e}},template:`
      <AtomDatetime
...
}`,...D.parameters?.docs?.source}}};const M=["Default","AdvancedDateConstraints","HighlightingSpecificDatesArray","HighlightingSpecificDatesCallback","WithMultipleDates","UsingRangeMode","RangeModeWithDefaultDates","RangeModeWithDefaultDatesAndButton","RangeModeWithMinMax","UsingWithButton","RangeModeCustomButtonText"];export{i as AdvancedDateConstraints,r as Default,l as HighlightingSpecificDatesArray,d as HighlightingSpecificDatesCallback,D as RangeModeCustomButtonText,u as RangeModeWithDefaultDates,p as RangeModeWithDefaultDatesAndButton,h as RangeModeWithMinMax,c as UsingRangeMode,g as UsingWithButton,m as WithMultipleDates,M as __namedExportsOrder,I as default};
