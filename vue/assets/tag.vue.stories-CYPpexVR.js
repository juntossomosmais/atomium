import{q as rr}from"./index-Dmbs_eUD.js";import"./vue.esm-bundler-Cotndkpi.js";import"./iframe-CQFnB7GW.js";import"../sb-preview/runtime.js";const er={decorators:[],parameters:{actions:{handles:[]},docs:{description:{component:`Tags are non-interactive elements used to categorize, highlight or organize items in the interface. Because they have short keywords, they help in the quick recognition of a category or element. 
...
}`,...($=(_=i.parameters)==null?void 0:_.docs)==null?void 0:$.source}}};var q,z,E;l.parameters={...l.parameters,docs:{...(q=l.parameters)==null?void 0:q.docs,source:{originalSource:`{
  render: args => createTag(args),
  args: {
    color: 'info',
    label: 'Partial Delivery',
...
}`,...(E=(z=l.parameters)==null?void 0:z.docs)==null?void 0:E.source}}};var O,R,V;g.parameters={...g.parameters,docs:{...(O=g.parameters)==null?void 0:O.docs,source:{originalSource:`{
  render: args => createTag(args),
  args: {
    color: 'dark',
    label: 'Most rescued',
