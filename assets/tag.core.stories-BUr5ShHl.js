import{H as e}from"./storybook-CfikGCXO.js";var t={title:`Components/Tag`,decorators:[],parameters:{actions:{handles:[]},docs:{description:{component:`Tags are non-interactive elements used to categorize, highlight or organize items in the interface. Because they have short keywords, they help in the quick recognition of a category or element. 
 ...
 Wrapper of Ionic Badge component. Read the [Ionic documentation](https://ionicframework.com/docs/api/badge) for more information about the available properties and possibilities.`}}},argTypes:{color:{control:`select`,options:[`success`,`warning`,`danger`,`neutral`,`dark`,`light`],defaultValue:{summary:`success`},description:`The type of the tag, the component will receive the color according to its type.`},icon:{control:`text`,description:`The name of the icon to use.`},label:{control:`text`,description:`The label of the tag`},customBackgroundColor:{control:`text`,description:`The background color`},customTextColor:{control:`text`,description:`The text and icon (if exists) color`}}},n=t=>e`
    <atom-tag
      color="${t.color}"
      icon="${t.icon}"
      custom-background-color="${t?.customBackgroundColor}"
      custom-text-color="${t?.customTextColor}"
    >
      ${t.label}
    </atom-tag>
  `,r={render:e=>n(e),args:{color:`success`,label:`Promotion`}},i={render:e=>n(e),args:{color:`success`,label:`Promotion`,icon:`tag`}},a={render:e=>n(e),args:{color:`danger`,label:`Canceled`}},o={render:e=>n(e),args:{color:`danger`,label:`Canceled`,icon:`close-circle-outline`}},s={render:e=>n(e),args:{color:`warning`,label:`In Progress`}},c={render:e=>n(e),args:{color:`warning`,label:`In Progress`,icon:`timer-outline`}},l={render:e=>n(e),args:{color:`info`,label:`Partial Delivery`}},u={render:e=>n(e),args:{color:`info`,label:`Partial Delivery`,icon:`truck`}},d={render:e=>n(e),args:{color:`dark`,label:`Most rescued`}},f={render:e=>n(e),args:{color:`dark`,label:`Most rescued`,icon:`wallet-giftcard`}},p={render:e=>n(e),args:{color:`light`,label:`More Points`}},m={render:e=>n(e),args:{color:`light`,label:`More Points`,icon:`plus-thick`}},h={render:e=>n(e),args:{label:`Most Loved`,icon:`heart`,customBackgroundColor:`#a006fa`,customTextColor:`#00ff95`}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
