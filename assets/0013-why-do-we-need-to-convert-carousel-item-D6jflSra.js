...
`,(0,r.jsxs)(i.p,{children:[`Because of the need of `,(0,r.jsx)(i.em,{children:`transport`}),` of `,(0,r.jsx)(i.code,{children:`atom-carousel-item`}),` content to inside `,(0,r.jsx)(i.code,{children:`swiper-slide`}),` to achieve framework compatibility we loose the lazy property. At our case is not a problem because swiper-slide's lazy property only add a loading spinner while image loads.`]})]})}function a(e={}){let{wrapper:n}={...t(),...e.components};return n?(0,r.jsx)(n,{...e,children:(0,r.jsx)(i,{...e})}):i(e)}export{a as default};