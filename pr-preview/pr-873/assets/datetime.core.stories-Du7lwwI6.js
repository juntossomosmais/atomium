...
return undefined;\``}})),d,f,p,m,h,g,_,v,y,b,x,S,C,w,T;e((()=>{t(),u(),d={title:`Components/Datetime`,...s},f={render:e=>n`
    <atom-datetime
  ...
  `,parameters:{docs:{description:{story:`This example shows the Datetime component in range mode with button interface, default dates (last 30 days), and custom Portuguese text in the button.`}}}},S={render:()=>n`
    <atom-datetime
      ...
      locale="pt-BR"
    ></atom-datetime>
  `,parameters:{docs:{description:{story:`Range mode with the button interface and the default Cancelar/Limpar/Confirmar buttons. While the calendar is open, selecting a start and end date highlights every day in between, even though ion-datetime only emits its value on "Confirmar".`}}}},C={render:()=>n`
    <atom-datetime
      range-mode
      use-button="true"
      ...
      .value=${v()}
    ></atom-datetime>
  `,parameters:{docs:{description:{story:`This example shows the Datetime component in range mode with min/max date restrictions (last 30 days, max is today).`}}}},w={render:()=>n`
    <atom-grid>
      <atom-col size="8">
        <atom-datetime
          use-button="true"
  ...
  parameters: {
    docs: {
      description: {
        story: 'Range mode with the button interface and the default Cancelar/Limpar/Confirmar buttons. While the calendar is open, selecting a start and end date highlights every day in between, even though ion-datetime only emits its value on "Confirmar".'
      }
    }
  }
  ...
  \`
}`,...w.parameters?.docs?.source}}},T=[`Default`,`AdvancedDateConstraints`,`HighlightingSpecificDatesArray`,`HighlightingSpecificDatesCallback`,`WithMultipleDates`,`UsingRangeMode`,`RangeModeWithDefaultDates`,`RangeModeWithDefaultDatesAndButton`,`RangeModeWithButtonAndDefaultButtons`,`RangeModeWithMinMax`,`UsingWithButton`]}))();export{p as AdvancedDateConstraints,f as Default,m as HighlightingSpecificDatesArray,h as HighlightingSpecificDatesCallback,S as RangeModeWithButtonAndDefaultButtons,b as RangeModeWithDefaultDates,x as RangeModeWithDefaultDatesAndButton,C as RangeModeWithMinMax,_ as UsingRangeMode,w as UsingWithButton,g as WithMultipleDates,T as __namedExportsOrder,d as default};