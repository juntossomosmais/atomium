import{u as z}from"./index-Ca_lK3Sf.js";import"./vue.esm-bundler-cJVerQom.js";import"./iframe-BL5b-ctO.js";const v={decorators:[],parameters:{actions:{handles:[]},docs:{description:{component:"Meters are visual representations of a quantity or an achievement. Their progress is determined by the actions of the user, not by the actions of the  system. This last point is what differentiates them from the progress bar."}}},argTypes:{type:{control:"select",options:["neutral","success","warning","danger"],defaultValue:{summary:"neutral"},description:"The type of the Meter, the component will receive the color according to its type."},size:{control:"select",options:["large","small"],defaultValue:{summary:"large"},description:"The size of the Meter, the componente will receive the size according to its prop."},title:{control:"text",description:"Top title of the Meter, at the top left of the component."},centerTitle:{control:"boolean",defaultValue:{summary:!1},description:"The prop to center the title."},min:{control:"number",description:"Minimum value for progression calculation."},max:{control:"number",description:"Max value for progression calculation."},actual:{control:"number",description:"Actual value for progression calculation."},content:{control:"text",description:"This prop is a children, used to fill the slot of the component."}}},N={title:"Components/Meter",...v},t=e=>({components:{AtomMeter:z},setup(){return{args:e}},template:`
    <AtomMeter
      type="${e.type}"
      size="${e.size}"
      title="${e.title}"
