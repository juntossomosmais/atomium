...
return undefined;\``},J={title:"Components/Datetime",...G},a={render:e=>({components:{AtomDatetime:t},setup(){return{args:e}},template:`
      <AtomDatetime
    ...
    `}),args:{...R}},n={render:()=>({components:{AtomDatetime:t},setup(){return{isDateEnabled:m=>{const c=new Date(m).getUTCDay();return c!==0&&c!==6}}},template:`
      <AtomDatetime :isDateEnabled="isDateEnabled" />
    `}),parameters:{docs:{description:{story:u.advancedDateConstraints}}}},i={render:e=>({components:{AtomDatetime:t},setup(){return{args:e}},template:`
      <AtomDatetime
        highlightedDates="${e.highlightedDates}"
        value="2025-01-01"
      />
    `}),args:{highlightedDates:[{date:"2025-01-05",textColor:"#800080",backgroundColor:"#ffc0cb"},{date:"2025-01-10",textColor:"#09721b",backgroundColor:"#c8e5d0"},{date:"2025-01-23",textColor:"rgb(68, 10, 184)",backgroundColor:"rgb(211, 200, 229)"}]},parameters:{docs:{description:{story:u.highlightingSpecificDatesArray}}}},r={render:()=>({components:{AtomDatetime:t},setup(){return{highlightedDates:m=>{if(new Date(m).getUTCDate()%5===0)return{textColor:"#800080",backgroundColor:"#ffc0cb"}}}},template:`
      <AtomDatetime
        :highlightedDates="highlightedDates"
      />
    `}),parameters:{docs:{description:{story:u.highlightingSpecificDatesCallback}}}},s={render:()=>({components:{AtomDatetime:t},template:`
    ...
    `})},d={render:e=>({components:{AtomDatetime:t,AtomCol:O,AtomGrid:U},setup(){return{args:e}},template:`
      <AtomGrid>
        <AtomCol size="8">
          <AtomDatetime
            useButton="true"
    ...
    `})};var h,p,g;a.parameters={...a.parameters,docs:{...(h=a.parameters)==null?void 0:h.docs,source:{originalSource:`{
  render: args => ({
    components: {
      AtomDatetime
    },
...
}`,...(g=(p=a.parameters)==null?void 0:p.docs)==null?void 0:g.source}}};var f,D,b;n.parameters={...n.parameters,docs:{...(f=n.parameters)==null?void 0:f.docs,source:{originalSource:`{
  render: () => ({
    components: {
      AtomDatetime
    },
...
}`,...(b=(D=n.parameters)==null?void 0:D.docs)==null?void 0:b.source}}};var y,w,x;i.parameters={...i.parameters,docs:{...(y=i.parameters)==null?void 0:y.docs,source:{originalSource:`{
  render: args => ({
    components: {
      AtomDatetime
    },
...
}`,...(x=(w=i.parameters)==null?void 0:w.docs)==null?void 0:x.source}}};var T,C,A;r.parameters={...r.parameters,docs:{...(T=r.parameters)==null?void 0:T.docs,source:{originalSource:`{
  render: () => ({
    components: {
      AtomDatetime
    },
...
}`,...(A=(C=r.parameters)==null?void 0:C.docs)==null?void 0:A.source}}};var $,S,v;s.parameters={...s.parameters,docs:{...($=s.parameters)==null?void 0:$.docs,source:{originalSource:`{
  render: () => ({
    components: {
      AtomDatetime
    },
...
}`,...(v=(S=s.parameters)==null?void 0:S.docs)==null?void 0:v.source}}};var B,I,V;l.parameters={...l.parameters,docs:{...(B=l.parameters)==null?void 0:B.docs,source:{originalSource:`{
  render: () => ({
    components: {
      AtomDatetime
    },
...
}`,...(V=(I=l.parameters)==null?void 0:I.docs)==null?void 0:V.source}}};var k,E,L;d.parameters={...d.parameters,docs:{...(k=d.parameters)==null?void 0:k.docs,source:{originalSource:`{
  render: args => ({
    components: {
      AtomDatetime,
      AtomCol,
...
}`,...(L=(E=d.parameters)==null?void 0:E.docs)==null?void 0:L.source}}};const K=["Default","AdvancedDateConstraints","HighlightingSpecificDatesArray","HighlightingSpecificDatesCallback","WithMultipleDates","UsingRangeMode","UsingWithButton"];export{n as AdvancedDateConstraints,a as Default,i as HighlightingSpecificDatesArray,r as HighlightingSpecificDatesCallback,l as UsingRangeMode,d as UsingWithButton,s as WithMultipleDates,K as __namedExportsOrder,J as default};
