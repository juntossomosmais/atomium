...
return undefined;\``},J={title:"Components/Datetime",...G},o={render:e=>({components:{AtomDatetime:t},setup(){return{args:e}},template:`
    ...
    `}),parameters:{docs:{description:{story:u.advancedDateConstraints}}}},i={render:e=>({components:{AtomDatetime:t},setup(){return{args:e}},template:`
      <AtomDatetime
        ...
        value="2025-01-01"
      />
    `}),args:{highlightedDates:[{date:"2025-01-05",textColor:"#800080",backgroundColor:"#ffc0cb"},{date:"2025-01-10",textColor:"#09721b",backgroundColor:"#c8e5d0"},{date:"2025-01-23",textColor:"rgb(68, 10, 184)",backgroundColor:"rgb(211, 200, 229)"}]},parameters:{docs:{description:{story:u.highlightingSpecificDatesArray}}}},s={render:()=>({components:{AtomDatetime:t},setup(){return{highlightedDates:m=>{if(new Date(m).getUTCDate()%5===0)return{textColor:"#800080",backgroundColor:"#ffc0cb"}}}},template:`
      <AtomDatetime
        :highlightedDates="highlightedDates"
      />
    `}),parameters:{docs:{description:{story:u.highlightingSpecificDatesCallback}}}},r={render:()=>({components:{AtomDatetime:t},template:`
...
}`,...(C=(w=i.parameters)==null?void 0:w.docs)==null?void 0:C.source}}};var T,x,A;s.parameters={...s.parameters,docs:{...(T=s.parameters)==null?void 0:T.docs,source:{originalSource:`{
  render: () => ({
    components: {
      AtomDatetime
    },
...
}`,...(A=(x=s.parameters)==null?void 0:x.docs)==null?void 0:A.source}}};var S,$,B;r.parameters={...r.parameters,docs:{...(S=r.parameters)==null?void 0:S.docs,source:{originalSource:`{
  render: () => ({
    components: {
      AtomDatetime
    },
...
}`,...(B=($=r.parameters)==null?void 0:$.docs)==null?void 0:B.source}}};var v,I,V;l.parameters={...l.parameters,docs:{...(v=l.parameters)==null?void 0:v.docs,source:{originalSource:`{
  render: () => ({
    components: {
      AtomDatetime
    },
