import{v as rr}from"./index-DVdXa43r.js";import"./vue.esm-bundler-B2N54QI-.js";import"./iframe-CZ2Tkf3r.js";import"../sb-preview/runtime.js";const er={decorators:[],parameters:{actions:{handles:[]},docs:{description:{component:`Tags are non-interactive elements used to categorize, highlight or organize items in the interface. Because they have short keywords, they help in the quick recognition of a category or element. 
...
}`,...(y=(x=s.parameters)==null?void 0:x.docs)==null?void 0:y.source}}};var v,D,w;c.parameters={...c.parameters,docs:{...(v=c.parameters)==null?void 0:v.docs,source:{originalSource:`{
  render: args => createTag(args),
  args: {
    color: 'warning',
    label: 'In Progress',
...
}`,...(w=(D=c.parameters)==null?void 0:D.docs)==null?void 0:w.source}}};var M,B,L;t.parameters={...t.parameters,docs:{...(M=t.parameters)==null?void 0:M.docs,source:{originalSource:`{
  render: args => createTag(args),
  args: {
    color: 'warning',
    label: 'In Progress',
