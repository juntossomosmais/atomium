...
return undefined;\``}})),h,g,_,v,y,b,x,S,C,w,T,E,D,O,k;e((()=>{n(),o(),m(),h=t(),g=()=>{let e=new Date,t=new Date;t.setDate(e.getDate()-30);let n=e=>e.toISOString().slice(0,10);return[n(t),n(e)]},_=new Date().toISOString().slice(0,10),v={title:`Components/Datetime`,...d},y={render:e=>(0,h.jsxs)(r,{cancelText:e.cancelText,clearText:e.clearText,disabled:e.disabled,doneText:e.doneText,"hour-cycle":e.hourCycle,locale:e.locale,max:e.max,min:e.min,multiple:e.multiple,name:e.name,presentation:e.presentation,readonly:e.readonly,showClearButton:e.showClearButton,showDefaultButtons:e.showDefaultButtons,showDefaultTimeLabel:e.showDefaultTimeLabel,showDefaultTitle:e.showDefaultTitle,size:e.size,useButton:e.useButton,value:e.value,children:[(0,h.jsx)(`span`,{slot:`time-label`,children:e.timeLabel}),(0,h.jsx)(`span`,{slot:`title`,children:e.title})]}),args:{...f}},b={render:e=>(0,h.jsx)(r,{isDateEnabled:e.isDateEnabled}),args:{isDateEnabled:e=>{let t=new Date(e).getUTCDay();return t!==0&&t!==6}},parameters:{docs:{description:{story:p.advancedDateConstraints}}}},x={render:e=>(0,h.jsx)(r,{highlightedDates:e.highlightedDates,value:`2025-01-01`}),args:{highlightedDates:[{date:`2025-01-05`,textColor:`#800080`,backgroundColor:`#ffc0cb`},{date:`2025-01-10`,textColor:`#09721b`,backgroundColor:`#c8e5d0`},{date:`2025-01-23`,textColor:`rgb(68, 10, 184)`,backgroundColor:`rgb(211, 200, 229)`}]},parameters:{docs:{description:{story:p.highlightingSpecificDatesArray}}}},S={render:e=>(0,h.jsx)(r,{highlightedDates:e.highlightedDates}),args:{highlightedDates:e=>{if(new Date(e).getUTCDate()%5==0)return{textColor:`#800080`,backgroundColor:`#ffc0cb`}}},parameters:{docs:{description:{story:p.highlightingSpecificDatesCallback}}}},C={render:()=>(0,h.jsx)(r,{multiple:!0})},w={render:()=>(0,h.jsx)(r,{rangeMode:!0})},T={render:()=>(0,h.jsx)(r,{rangeMode:!0,value:g()}),parameters:{docs:{description:{story:`This example shows the Datetime component in range mode with default start and end dates pre-selected (last 30 days).`}}}},E={render:()=>(0,h.jsx)(r,{rangeMode:!0,useButton:!0,label:`Selecionar período`,datetimeId:`datetime-range-with-button`,cancelText:`Cancelar`,clearText:`Limpar`,doneText:`Confirmar`,locale:`pt-BR`,value:g()}),parameters:{docs:{description:{story:`This example shows the Datetime component in range mode with button interface and default dates (last 30 days).`}}}},D={render:()=>(0,h.jsx)(r,{rangeMode:!0,min:`2025-01-01`,max:_,value:g(),useButton:!0,label:`Selecionar período de verão`,datetimeId:`datetime-range-constrained`,cancelText:`Cancelar`,clearText:`Limpar`,doneText:`Confirmar`,locale:`pt-BR`}),parameters:{docs:{description:{story:`This example demonstrates range mode with min/max constraints and default last 30 days selection (max is today).`}}}},O={render:()=>(0,h.jsxs)(a,{children:[(0,h.jsx)(i,{size:`8`,children:(0,h.jsx)(r,{useButton:!0,label:`Selecione uma data`,datetimeId:`datetime-with-button-date`,presentation:`date`})}),(0,h.jsx)(i,{size:`8`,children:(0,h.jsx)(r,{useButton:!0,label:`Selecione uma hora`,datetimeId:`datetime-with-button-time`,presentation:`time`})}),(0,h.jsx)(i,{size:`8`,children:(0,h.jsx)(r,{useButton:!0,label:`Selecione um mês e ano`,datetimeId:`datetime-with-button-year-month`,presentation:`month-year`,formatOptions:{date:{month:`long`,year:`numeric`}}})}),(0,h.jsx)(i,{size:`8`,children:(0,h.jsx)(r,{useButton:!0,label:`Selecione uma data`,datetimeId:`datetime-with-custom-date-format`,presentation:`date`,children:(0,h.jsx)(`span`,{slot:`date-target`,children:`Custom-Date`})})})]})},y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`{
