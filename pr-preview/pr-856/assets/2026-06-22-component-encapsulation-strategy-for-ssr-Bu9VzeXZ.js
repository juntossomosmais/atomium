...
`,(0,c.jsxs)(t.p,{children:[`After `,(0,c.jsx)(t.a,{href:`./2026-06-12-server-side-rendering-hydration.mdx`,children:`SSR hydration`}),` shipped, a Cadastro flow E2E in Colosseum (HML/DEV) found that `,(0,c.jsx)(t.code,{children:`atom-input`}),` (CPF) was inert under SSR: the mask never applied, the value never reached React Hook Form, and the submit button stayed disabled because it enables via `,(0,c.jsx)(t.code,{children:`onAtomInput`}),`.`]}),`
...
`]}),`
`,(0,c.jsxs)(t.p,{children:[`That nested-scoped case is exactly what made `,(0,c.jsx)(t.code,{children:`atom-input`}),` dead on the Cadastro form.`]}),`
...
`,(0,c.jsxs)(t.ul,{children:[`
`,(0,c.jsxs)(t.li,{children:[`✅ `,(0,c.jsx)(t.code,{children:`atom-input`}),` is interactive under SSR (mask, value, validation), fixing the Cadastro regression.`]}),`
