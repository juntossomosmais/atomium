import{C as p}from"./index-C4Pcom88.js";import"./vue.esm-bundler-HaV7LZ5z.js";import"./iframe-Brz20IXs.js";import"../sb-preview/runtime.js";const m={decorators:[],parameters:{actions:{handles:[]},docs:{description:{component:"Container is a component that wraps content in application using a max-width and padding to define the width of the content."}}},argTypes:{hasPadding:{control:"boolean",defaultValue:{summary:!0},description:"If false the container will not have padding"}}},C={title:"Components/Container",...m},c=e=>({components:{AtomContainer:p},setup(){return{args:e}},template:`
...
}`,...(d=(i=t.parameters)==null?void 0:i.docs)==null?void 0:d.source}}};const f=["Default","NoPadding"];export{a as Default,t as NoPadding,f as __namedExportsOrder,C as default};
