import{C as b,s as f}from"./index-CYPV5ngz.js";import{C as t}from"./table-D060eKuu.js";import{w as v}from"./decorator-Dt3Huotz.js";import"./vue.esm-bundler-D6ApT1Ci.js";import"./iframe-BCmO2hXq.js";import"../sb-preview/runtime.js";import"./v4-CQkTLCs1.js";const E={parameters:{actions:{handles:["atomOpen","atomClose"]},decorators:[v],docs:{description:{component:"Tooltip is a small pop-up box that appears when a user moves a mouse over an element"}},layout:"centered"},argTypes:{placement:{control:"select",defaultValue:{summary:"top"},options:["auto","auto-start","auto-end","top","top-start","top-end","bottom","bottom-start","bottom-end","right","left"],description:"Determines placement for tooltip",table:{category:t.PROPERTIES}},action:{control:"select",defaultValue:{summary:"hover"},options:["hover","click"],description:"Determines the trigger action for the tooltip: `hover` or `click`.",table:{category:t.PROPERTIES}},element:{control:"text",description:"Specifies the element responsible for opening/closing the tooltip.",table:{category:t.PROPERTIES}},open:{control:"boolean",description:"Controls whether the tooltip is open or closed.",table:{category:t.PROPERTIES}},text:{control:"text",description:"Determines a text for tooltip.",table:{category:t.PROPERTIES}},atomOpen:{description:"Event emitted when hover element, but for mobile when click in element.",table:{category:t.EVENTS}},atomClose:{description:"Event emitted when the tooltip is closed.",table:{category:t.EVENTS}}}},a={element:"atomium-element",placement:"top",text:"Tooltip",action:"hover",open:!1},R={title:"Components/Tooltip",...E},i=(e,T="Hover")=>({components:{AtomTooltip:b,AtomButton:f},setup(){return{args:e}},template:`
  ...
  `}),o={render:e=>i(e),args:{...a,element:"hover"}},n={render:e=>i(e,"Click"),args:{...a,element:"click",placement:"top",action:"click"}},r={render:e=>i(e,"Opened"),args:{...a,element:"opened",placement:"left",action:"click",open:!0}};var l,s,p;o.parameters={...o.parameters,docs:{...(l=o.parameters)==null?void 0:l.docs,source:{originalSource:`{
