import{l as R}from"./index-DP8BYyHe.js";import{w as S}from"./decorator-Dt3Huotz.js";import{C as r}from"./table-D060eKuu.js";import"./vue.esm-bundler-D6ApT1Ci.js";import"./iframe-DR7eZa3e.js";import"../sb-preview/runtime.js";import"./v4-CQkTLCs1.js";const P={decorators:[S],parameters:{actions:{handles:["atomClick"]},docs:{description:{component:"Wrapper of Ionic Chip component. Read the [Ionic documentation](https://ionicframework.com/docs/api/chip) for more information about the available properties and possibilities."}}},argTypes:{disabled:{control:"boolean",defaultValue:{summary:!1},description:"If true, the user cannot interact with the chip.",table:{category:r.PROPERTIES}},activated:{control:"boolean",defaultValue:{summary:!1},description:"If true, the chip will be activated.",table:{category:r.PROPERTIES}},icon:{control:"text",description:"If have an value, the chip will have an icon.",table:{category:r.PROPERTIES}},close:{control:"boolean",defaultValue:{summary:!1},description:"If true, the chip will have a close button.",table:{category:r.PROPERTIES}},mode:{control:"select",options:["md","ios"],defaultValue:{summary:"md"},description:"The mode determines which platform styles to use.",table:{category:r.PROPERTIES}},atomClick:{action:"atomClick",description:"Emitted when the chip is clicked.",table:{category:"Events"}}}},o={mode:"md",disabled:!1,activated:!1,close:!1,label:"Label"},V={title:"Components/Chip",...P},t=e=>({components:{AtomChip:R},setup(){return{args:e}},template:`
  ...
  `}),a={render:e=>t(e),args:{...o}},s={render:e=>t(e),args:{...o,disabled:!0}},c={render:e=>t(e),args:{...o,activated:!0}},n={render:e=>t(e),args:{...o,icon:"check"}},i={render:e=>t(e),args:{...o,close:!0}};var p,l,d;a.parameters={...a.parameters,docs:{...(p=a.parameters)==null?void 0:p.docs,source:{originalSource:`{
  render: args => createChip(args),
  args: {
    ...ChipComponentArgs
  }
}`,...(d=(l=a.parameters)==null?void 0:l.docs)==null?void 0:d.source}}};var m,h,u;s.parameters={...s.parameters,docs:{...(m=s.parameters)==null?void 0:m.docs,source:{originalSource:`{
  render: args => createChip(args),
  args: {
    ...ChipComponentArgs,
    disabled: true
...
}`,...(I=(E=i.parameters)==null?void 0:E.docs)==null?void 0:I.source}}};const _=["Default","Disabled","Activated","WithIcon","WithClose"];export{c as Activated,a as Default,s as Disabled,i as WithClose,n as WithIcon,_ as __namedExportsOrder,V as default};
