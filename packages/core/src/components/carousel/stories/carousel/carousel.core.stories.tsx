...
const createComponent = (args, itemClass: string) => {
  ...
  return html`
    ...
    >
      <atom-carousel-item
        ><div class="${itemClass}">Slide 1</div></atom-carousel-item
      >
      <atom-carousel-item
        ><div class="${itemClass}">Slide 2</div></atom-carousel-item
      >
      <atom-carousel-item
        ><div class="${itemClass}">Slide 3</div></atom-carousel-item
      >
      <atom-carousel-item
        ><div class="${itemClass}">Slide 4</div></atom-carousel-item
      >
      <atom-carousel-item
        ><div class="${itemClass}">Slide 5</div></atom-carousel-item
      >
      <atom-carousel-item
        ><div class="${itemClass}">Slide 6</div></atom-carousel-item
      >
      <atom-carousel-item
        ><div class="${itemClass}">Slide 7</div></atom-carousel-item
      >
      <atom-carousel-item
        ><div class="${itemClass}">Slide 8</div></atom-carousel-item
      >
    ...
    <script>
      const atomCarousel${carouselStoryId} = document.querySelector(
        'atom-carousel#carousel-${carouselStoryId}'
      )
      atomCarousel${carouselStoryId}.addEventListener('atomChange', (event) => {
        console.log('atomChange', event)
      })
      atomCarousel${carouselStoryId}.addEventListener(
        'atomClickPrev',
        (event) => {
