...
import { k as assert, s as shallowEqualStringMap } from './helpers-937ea457.js';
import { l as lifecycle, t as transition, s as setPageHidden, L as LIFECYCLE_WILL_UNLOAD, a as LIFECYCLE_WILL_LEAVE, b as LIFECYCLE_DID_LEAVE } from './index-aae540f5.js';
...
const Nav = class {
  ...
  async componentDidLoad() {
    this.rootChanged();
    this.gesture = (await import('./swipe-back-fe7ee8ee.js')).createSwipeBackGesture(this.el, this.canStart.bind(this), this.onStart.bind(this), this.onMove.bind(this), this.onEnd.bind(this));
...
//# sourceMappingURL=ion-nav.entry.js.map