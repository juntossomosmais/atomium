...
const index = require('./index-206cca84.js');
...
const ActionSheet = class {
  ...
  async present() {
    ...
    this.currentTransition = overlays.present(this, 'actionSheetEnter', iosEnterAnimation$2, mdEnterAnimation$2);
    await this.currentTransition;
    this.currentTransition = undefined;
  }
  async dismiss(data, role) {
    this.currentTransition = overlays.dismiss(this, data, role, 'actionSheetLeave', iosLeaveAnimation$2, mdLeaveAnimation$2);
...
const Alert = class {
  constructor(hostRef) {
    ...
    this.delegateController = overlays.createDelegateController(this);
    this.triggerController = overlays.createTriggerController();
    this.customHTMLEnabled = ionicGlobal.config.get('innerHTMLTemplatesEnabled', index$2.ENABLE_HTML_CONTENT_DEFAULT);
  ...
  async present() {
    ...
    await this.delegateController.attachViewToDom();
    this.currentTransition = overlays.present(this, 'alertEnter', iosEnterAnimation$1, mdEnterAnimation$1);
    await this.currentTransition;
    this.currentTransition = undefined;
  }
  async dismiss(data, role) {
    this.currentTransition = overlays.dismiss(this, data, role, 'alertLeave', iosLeaveAnimation$1, mdLeaveAnimation$1);
    const dismissed = await this.currentTransition;
    if (dismissed) {
      this.delegateController.removeViewFromDom();
    }
  ...
  renderAlertMessage(msgId) {
    ...
    if (customHTMLEnabled) {
      return index$1.h("div", { id: msgId, class: "alert-message", innerHTML: index$2.sanitizeDOMString(message) });
    }
...
const Checkbox = class {
  ...
  renderCheckbox() {
    ...
    return (index$1.h(index$1.Host, { class: theme.createColorClasses(color, {
        [mode]: true,
      ...
      }) }, index$1.h("label", { class: "checkbox-wrapper" }, index$1.h("input", Object.assign({ type: "checkbox", checked: checked ? true : undefined, disabled: disabled, id: inputId, onChange: this.toggleChecked, onFocus: () => this.onFocus(), onBlur: () => this.onBlur(), ref: (focusEl) => (this.focusEl = focusEl) }, inheritedAttributes)), index$1.h("div", { class: {
        'label-text-wrapper': true,
        'label-text-wrapper-hidden': el.textContent === '',
      } }, index$1.h("slot", null)), index$1.h("div", { class: "native-wrapper" }, index$1.h("svg", { class: "checkbox-icon", viewBox: "0 0 24 24", part: "container" }, path)))));
  }
  renderLegacyCheckbox() {
    if (!this.hasLoggedDeprecationWarning) {
      index$3.printIonWarning(`ion-checkbox now requires providing a label with either the default slot or the "aria-label" attribute. To migrate, remove any usage of "ion-label" and pass the label text to either the component or the "aria-label" attribute.
...
Developers can use the "legacy" property to continue using the legacy form markup. This property will be removed in an upcoming major release of Ionic where this form control will use the modern form markup.`, this.el);
      if (this.legacy) {
        index$3.printIonWarning(`ion-checkbox is being used with the "legacy" property enabled which will forcibly enable the legacy form markup. This property will be removed in an upcoming major release of Ionic where this form control will use the modern form markup.
Developers can dismiss this warning by removing their usage of the "legacy" property and using the new checkbox syntax.`, this.el);
    ...
    const path = getSVGPath(mode, indeterminate);
    helpers.renderHiddenInput(true, el, name, checked ? value : '', disabled);
    return (index$1.h(index$1.Host, { "aria-labelledby": label ? labelId : null, "aria-checked": `${checked}`, "aria-hidden": disabled ? 'true' : null, role: "checkbox", class: theme.createColorClasses(color, {
        [mode]: true,
        'in-item': theme.hostContext('ion-item', el),
        'checkbox-checked': checked,
        'checkbox-disabled': disabled,
        ...
        interactive: true,
      }) }, index$1.h("svg", { class: "checkbox-icon", viewBox: "0 0 24 24", part: "container" }, path), index$1.h("label", { htmlFor: inputId }, labelText), index$1.h("input", { type: "checkbox", "aria-checked": `${checked}`, disabled: disabled, id: inputId, onChange: this.toggleChecked, onFocus: () => this.onFocus(), onBlur: () => this.onBlur(), ref: (focusEl) => (this.focusEl = focusEl) })));
  }
  getSVGPath(mode, indeterminate) {
    let path = indeterminate ? (index$1.h("path", { d: "M6 12L18 12", part: "mark" })) : (index$1.h("path", { d: "M5.9,12.5l3.8,3.8l8.8-8.8", part: "mark" }));
    if (mode === 'md') {
      path = indeterminate ? (index$1.h("path", { d: "M2 12H22", part: "mark" })) : (index$1.h("path", { d: "M1.73,12.91 8.1,19.28 22.79,4.59", part: "mark" }));
    }
    return path;
  }
  get el() { return index$1.getElement(this); }
...
const ListHeader = class {
  ...
  render() {
    ...
    return (index$1.h(index$1.Host, { class: theme.createColorClasses(this.color, {
      ...
      }) }, index$1.h("div", { class: "list-header-inner" }, index$1.h("slot", null))));
  }
};
ListHeader.style = {
...
const Popover = class {
  constructor(hostRef) {
    ...
    this.willDismissShorthand = index$1.createEvent(this, "willDismiss", 7);
    this.didDismissShorthand = index$1.createEvent(this, "didDismiss", 7);
    this.ionMount = index$1.createEvent(this, "ionMount", 7);
    ...
    this.configureTriggerInteraction = () => {
      ...
      if (!triggerEl) {
        index$3.printIonWarning(`A trigger element with the ID "${trigger}" was not found in the DOM. The trigger element must be in the DOM when the "trigger" property is set on ion-popover.`, this.el);
        return;
      }
  ...
  async present(event) {
    ...
    helpers.hasLazyBuild(el) && (await index$4.deepReady(this.usersElement));
...
const Radio = class {
  ...
  renderRadioControl() {
    return (index$1.h("div", { class: "radio-icon", part: "container" }, index$1.h("div", { class: "radio-inner", part: "mark" }), index$1.h("div", { class: "radio-ripple" })));
  }
  render() {
    const { legacyFormController } = this;
  ...
  renderRadio() {
    ...
    return (index$1.h(index$1.Host, { onClick: this.onClick, class: theme.createColorClasses(color, {
        [mode]: true,
        'in-item': inItem,
      ...
      }) }, index$1.h("label", { class: "radio-wrapper" }, index$1.h("input", Object.assign({ type: "radio", checked: checked, disabled: disabled, id: inputId, ref: (nativeEl) => (this.nativeInput = nativeEl) }, inheritedAttributes)), index$1.h("div", { class: {
        'label-text-wrapper': true,
        'label-text-wrapper-hidden': !hasLabel,
      } }, index$1.h("slot", null)), index$1.h("div", { class: "native-wrapper" }, this.renderRadioControl()))));
  }
  renderLegacyRadio() {
    if (!this.hasLoggedDeprecationWarning) {
      index$3.printIonWarning(`ion-radio now requires providing a label with either the default slot or the "aria-label" attribute. To migrate, remove any usage of "ion-label" and pass the label text to either the component or the "aria-label" attribute.
...
Developers can use the "legacy" property to continue using the legacy form markup. This property will be removed in an upcoming major release of Ionic where this form control will use the modern form markup.`, this.el);
      if (this.legacy) {
        index$3.printIonWarning(`ion-radio is being used with the "legacy" property enabled which will forcibly enable the legacy form markup. This property will be removed in an upcoming major release of Ionic where this form control will use the modern form markup.
...
Developers can dismiss this warning by removing their usage of the "legacy" property and using the new radio syntax.`, this.el);
    ...
    const mode = ionicGlobal.getIonMode(this);
    const { label, labelId, labelText } = helpers.getAriaLabel(el, inputId);
    return (index$1.h(index$1.Host, { "aria-checked": `${checked}`, "aria-hidden": disabled ? 'true' : null, "aria-labelledby": label ? labelId : null, role: "radio", tabindex: buttonTabindex, onFocus: this.onFocus, onBlur: this.onBlur, onClick: this.onClick, class: theme.createColorClasses(color, {
        [mode]: true,
        'in-item': theme.hostContext('ion-item', el),
        interactive: true,
        'radio-checked': checked,
        'radio-disabled': disabled,
        'legacy-radio': true,
      }) }, this.renderRadioControl(), index$1.h("label", { htmlFor: inputId }, labelText), index$1.h("input", { type: "radio", checked: checked, disabled: disabled, tabindex: "-1", id: inputId, ref: (nativeEl) => (this.nativeInput = nativeEl) })));
  }
  get el() { return index$1.getElement(this); }
  static get watchers() { return {
    "value": ["valueChanged"],
...
const RadioGroup = class {
  ...
  render() {
    ...
    return index$1.h(index$1.Host, { role: "radiogroup", "aria-labelledby": label ? labelId : null, onClick: this.onClick, class: mode });
  }
  get el() { return index$1.getElement(this); }
  static get watchers() { return {
    "value": ["valueChanged"]
...
const SelectPopover = class {
  ...
  renderCheckboxOptions(options) {
    return options.map((option) => (index$1.h("ion-item", { class: theme.getClassMap(option.cssClass) }, index$1.h("ion-checkbox", { slot: "start", value: option.value, disabled: option.disabled, checked: option.checked, legacy: true, onIonChange: (ev) => {
        this.setChecked(ev);
        this.callOptionHandler(ev);
      } }), index$1.h("ion-label", null, option.text))));
  }
  renderRadioOptions(options) {
    const checked = options.filter((o) => o.checked).map((o) => o.value)[0];
    return (index$1.h("ion-radio-group", { value: checked, onIonChange: (ev) => this.callOptionHandler(ev) }, options.map((option) => (index$1.h("ion-item", { class: theme.getClassMap(option.cssClass) }, index$1.h("ion-label", null, option.text), index$1.h("ion-radio", { value: option.value, disabled: option.disabled, legacy: true, onClick: () => this.dismissParentPopover(), onKeyUp: (ev) => {
        if (ev.key === ' ') {
...
//# sourceMappingURL=ion-action-sheet_9.cjs.entry.js.map