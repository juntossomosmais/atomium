...
import type { JSX } from '@juntossomosmais/atomium/dist';

import { applyPolyfills, defineCustomElements } from '@juntossomosmais/atomium/loader';

applyPolyfills().then(() => defineCustomElements());
export const AtomButton = /*@__PURE__*/createReactComponent<JSX.AtomButton, HTMLAtomButtonElement>('atom-button');
export const AtomCol = /*@__PURE__*/createReactComponent<JSX.AtomCol, HTMLAtomColElement>('atom-col');
export const AtomGrid = /*@__PURE__*/createReactComponent<JSX.AtomGrid, HTMLAtomGridElement>('atom-grid');
export const AtomIcon = /*@__PURE__*/createReactComponent<JSX.AtomIcon, HTMLAtomIconElement>('atom-icon');
export const AtomInput = /*@__PURE__*/createReactComponent<JSX.AtomInput, HTMLAtomInputElement>('atom-input');
export const AtomRow = /*@__PURE__*/createReactComponent<JSX.AtomRow, HTMLAtomRowElement>('atom-row');
export const AtomSelect = /*@__PURE__*/createReactComponent<JSX.AtomSelect, HTMLAtomSelectElement>('atom-select');
...
export const IonDatetimeButton = /*@__PURE__*/createReactComponent<JSX.IonDatetimeButton, HTMLIonDatetimeButtonElement>('ion-datetime-button');
export const IonFab = /*@__PURE__*/createReactComponent<JSX.IonFab, HTMLIonFabElement>('ion-fab');
export const IonFabButton = /*@__PURE__*/createReactComponent<JSX.IonFabButton, HTMLIonFabButtonElement>('ion-fab-button');
...
export const IonItem = /*@__PURE__*/createReactComponent<JSX.IonItem, HTMLIonItemElement>('ion-item');
...
export const IonItemOption = /*@__PURE__*/createReactComponent<JSX.IonItemOption, HTMLIonItemOptionElement>('ion-item-option');
...
export const IonLoading = /*@__PURE__*/createReactComponent<JSX.IonLoading, HTMLIonLoadingElement>('ion-loading');
...
export const IonModal = /*@__PURE__*/createReactComponent<JSX.IonModal, HTMLIonModalElement>('ion-modal');
...
export const IonRoute = /*@__PURE__*/createReactComponent<JSX.IonRoute, HTMLIonRouteElement>('ion-route');
export const IonRouteRedirect = /*@__PURE__*/createReactComponent<JSX.IonRouteRedirect, HTMLIonRouteRedirectElement>('ion-route-redirect');
export const IonRouter = /*@__PURE__*/createReactComponent<JSX.IonRouter, HTMLIonRouterElement>('ion-router');
export const IonRouterLink = /*@__PURE__*/createReactComponent<JSX.IonRouterLink, HTMLIonRouterLinkElement>('ion-router-link');
...
export const IonTabBar = /*@__PURE__*/createReactComponent<JSX.IonTabBar, HTMLIonTabBarElement>('ion-tab-bar');
...
export const IonToast = /*@__PURE__*/createReactComponent<JSX.IonToast, HTMLIonToastElement>('ion-toast');
